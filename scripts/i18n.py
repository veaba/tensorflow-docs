i18n = {
    ...
    '## Functions': '## 功能',
    '## Other Members': '## 其他成员',
    '## Class AggregationMethod': '## AggregationMethod',
    '### Aliases:': '### 别名：',
    ...
    '#### Args:': '#### 参数：',
    '#### Returns:': '#### 返回：',
    'An int32 Tensor with the same shape as values. The indices that would sort each slice of the given values along the given axis.': '具有与值相同形状的 int32 张量。沿给定轴对给定值的每个切片进行排序的索引。',
    '#### Raises:': '#### 加薪：',
    ...
    '## Class CriticalSection': '## 类 CriticalSection',
    ...
    '## Class GradientTape': '## 类 GradientTape',
    ...
    '注意：This constructor validates the given name. Valid scope names match one of the following regular expressions:': '注意：此构造函数验证给定的名称。有效的作用域名称与下列正则表达式之一匹配：',
    ...
    '## Class IndexedSlices': '## IndexedSlices',
    ...
    '### consumers': '### 消费者',
    '## Class IndexedSlicesSpec': '## 类 IndexedSlicesSpec',
    ...
    '## Class OptionalSpec': '## 类 OptionalSpec',
    ...
    '## Class RaggedTensor': '## 类 RaggedTensor',
    ...
    '注意：Prefer using the Tensor division operator or tf.divide which obey Python 3 division operator semantics.': '注意：最好使用符合python 3除法运算符语义的张量除法运算符或tf.divide。',
    ...
    '注意：Prefer using the Tensor operator or tf.divide which obey Python division operator semantics.': '注意：最好使用符合python除法运算符语义的张量运算符或tf.divide。',
    ...
    '## Class RaggedTensorSpec': '## 类 RaggedTensorSpec',
    ...
    '## Class RegisterGradient': '## 类 RegisterGradient',
    ...
    'Some` `examples:': '一些“例子：',
    '## Class SparseTensorSpec': '##类 SparseTensorSpec',
    ...
    '## Class TensorArray': '## 类 TensorArray',
    ...
    '## Class TensorArraySpec': '## 类 TensorArraySpec',
    ...
    '## Class TensorShape': '## 类 TensorShape',
    ...
    '## Class TypeSpec': '## 类 TypeSpec',
    'Specifies a TensorFlow value type.': '指定TensorFlow值类型。',
    '## Class UnconnectedGradients': '## 类 UnconnectedGradients',
    ...
    '## Class SaveSliceInfo': '## 类 SaveSliceInfo',
    ...
    '## Class VariableAggregation': '## 类 VariableAggregation',
    'Indicates how a distributed variable will be aggregated.': '指示如何聚合分布式变量。',
    '## Class VariableSynchronization': '## VariableSynchronization',
    ...
    '## Class ConditionalAccumulatorBase': '## 类 ConditionalAccumulatorBase',
    '## Class ConfigProto': '## 类 ConfigProto',
    '### experimental': '### 实验的',
    'Experimental experimental': '实验性实验',
    '### key': '### 钥匙',
    'string key': '字符串键',
    '## Class Experimental': '## class Experimental',
    ...
    '## Class FixedLengthRecordReader': '## 类 FixedLengthRecordReader',
    ...
    '## Class LogMessage': '## 类 LogMessage',
    '### level': '### 水平',
    'Level level': '水平面',
    '### message': '### 消息',
    'string message': '字符串消息',
    '## Class MetaGraphDef': '## 类 MetaGraphDef',
    '## Class CollectionDefEntry': '## 集体防御',
    'CollectionDef value': '集合定义值',
    '## Class MetaInfoDef': '## 类 MetaInfoDef',
    '### tags': '### 标签',
    'repeated string tags': '重复的字符串标记',
    '## Class SignatureDefEntry': '## Class SignatureDefEntry',
    ...
    '## Class NameAttrList': '## 类 NameAttrList',
    '### attr': '### 属性',
    'repeated AttrEntry attr': '重复属性属性',
    'string name': '字符串名称',
    '## Class AttrEntry': '## 类 AttrEntry',
    'AttrValue value': '属性值',
    '## Class NodeDef': '## 类 NodeDef',
    'string device': '字符串设备',
    '### input': '### 输入',
    'repeated string input': '重复字符串输入',
    'string op': '字符串操作',
    '## Class ExperimentalDebugInfo': '## 类 ExperimentalDebugInfo',
    'Use this function to prevent regularization of variables.': '使用此函数可防止变量正则化。',
    '## Class OptimizerOptions': '## 类 OptimizerOptions',
    ...
    '## Class RunMetadata': '## 类 RunMetadata',
    '## Class FunctionGraphs': '## 类 FunctionGraphs',
    ...
    '## Class SparseConditionalAccumulator': '## 类 SparseConditionalAccumulator',
    ...
    '## Class SparseTensorValue': '## 类 SparseTensorValue',
    ...
    '### tag': '### 标签',
    'string tag': '字符串标记',
    '## Class SummaryMetadata': '## 类 SummaryMetadata',
    '## Class PluginData': '## 类 PluginData',
    '### content': '### 内容',
    'Returns an Op that initializes all tables of the default graph.': '返回初始化默认图的所有表的操作。',
    '## Class TensorInfo': '## 类 TensorInfo',
    'DataType dtype': '数据类型DTYPE',
    '## Class CooSparse': '## 类 CooSparse',
    '## Class TextLineReader': '## 类 TextLineReader',
    ...
    '## Class TFRecordReader': '## 类 TFRecordReader',
    ...
    '## Class VariableScope': '## 类 VariableScope',
    ...
    '## Class WholeFileReader': '## 类 WholeFileReader',
    ...
    '注意：This is an escape hatch for existing uses of filter that do not work with V2 functions. New uses are strongly discouraged and existing uses should migrate to filter as this method will be removed in V2.': '注意：这是一个转义图案填充，用于不使用v2函数的现有过滤器。强烈禁止新的使用，现有的使用应迁移到筛选器，因为此方法将在v2中删除。',
    ...
    '### map': '### 地图',
    '注意：This is an escape hatch for existing uses of map that do not work with V2 functions. New uses are strongly discouraged and existing uses should migrate to map as this method will be removed in V2.': '注意：这是一个转义图案填充，用于不使用v2函数的地图的现有用途。强烈禁止新的使用，现有的使用应该迁移到map，因为此方法将在v2中被删除。',
    '### options': '### 选项',
    ...
    '## Class FixedLengthRecordDataset': '## 类 FixedLengthRecordDataset',
    ...
    '## Class MirroredStrategy': '## Class MirroredStrategy',
    ...
    '## Class OneDeviceStrategy': '## 类 OneDeviceStrategy',
    ...
    '## Class Categorical': '## 类 Categorical',
    'Categorical distribution.': '分类分布。',
    '#### Pitfalls': '#### 陷阱',
    'Scalar int32 tensor: the number of classes.': '标量 int32 张量：类的数目。',
    'Vector of coordinatewise logits.': '协调逻辑向量。',
    'Vector of coordinatewise probabilities.': '协调概率向量。',
    '## Class Dirichlet': '## 类 Dirichlet',
    ...
    '## Class DirichletMultinomial': '## 类 DirichletMultinomial',
    ...
    '## Class Distribution': '## 类 Distribution',
    ...
    '## Class Exponential': '## 类 Exponential',
    ...
    '## Class Multinomial': '## 类 Multinomial',
    ...
    '## Class BaselineClassifier': '## 类 BaselineClassifier',
    ...
    '### train': '### 火车',
    '## Class BaselineEstimator': '## 类 BaselineEstimator',
    'An estimator that can establish a simple baseline.': '能建立简单基线的估计器。',
    '## Class BaselineRegressor': '## 类 BaselineRegressor',
    ...
    '## Class DNNClassifier': '## 类 DNNClassifier',
    ...
    '## Class InputPipelineConfig': '## 类 InputPipelineConfig',
    'Please see the definition of these values in TPUConfig.': '请参阅tpuconfig中这些值的定义。',
    '## Class RunConfig': '## 类 RunConfig',
    ...
    '## Class TPUEstimatorSpec': '## 类 TPUEstimatorSpec',
    ...
    '## Class EmbeddingConfigSpec': '## 类 EmbeddingConfigSpec',
    ...
    '## Class ArgumentSerializer': '## 类 ArgumentSerializer',
    ...
    '### unparse': '### 解开',
    '## Class BooleanParser': '## 类 BooleanParser',
    ...
    '## Class EnumClassFlag': '## 类 EnumClassFlag',
    ...
    '注意：MUST mirror the behavior of the C++ AppendFlagsIntoFile from https://github.com/gflags/gflags.': '注意：必须镜像来自https://github.com/gflags/gflags的c++appendflagsintofile的行为。',
    ...
    '注意：MUST mirror the behavior of the C++ CommandlineFlagsIntoString from https://github.com/gflags/gflags.': '注意：必须镜像来自https://github.com/gflags/gflags的C++命令行标记的行为。',
    ...
    '## Class UnrecognizedFlagError': '## 类 UnrecognizedFlagError',
    ...
    '## Class TFDecorator': '## 类 TFDecorator',
    ...
    '## Class CurrentModuleFilter': '## 类 CurrentModuleFilter',
    ...
    '## Class ResizeMethod': '## 类 ResizeMethod',
    ...
    '## Class TFRecordCompressionType': '## 类 TFRecordCompressionType',
    ...
    '## Class TensorBoard': '## 类 TensorBoard',
    ...
    '## Class Ones': '## 类 Ones',
    '## Class Orthogonal': '## 类 Orthogonal',
    'Initializer that generates an orthogonal matrix.': '生成正交矩阵的初始值设定项。',
    '## Class RandomNormal': '## 类 RandomNormal',
    'RandomNormal instance.': '随机正常实例。',
    '## Class RandomUniform': '## 类 RandomUniform',
    'A RandomUniform instance.': '随机均匀的例子。',
    '## Class TruncatedNormal': '## 类 TruncatedNormal',
    'A TruncatedNormal instance.': '截断的普通实例。',
    '## Class VarianceScaling': '## 类 VarianceScaling',
    ...
    '## Class OpHintArgumentTracker': '## 类 OphinTargumentTracker',
    ...
    '## Class TFLiteConverter': '## 类 TFLiteConverter',
    ...
    '## Class TocoConverter': '## 类 TocoConverter',
    ...
    '## Class TFLiteLSTMCell': '## 类 TFLiteLSTMCell',
    ...
    '## Class TfLiteRNNCell': '## 类 TfLiteRNNCell',
    ...
    '## Class StaticHashTable': '## 类 StaticHashTable',
    ...
    '## Class StaticVocabularyTable': '## 类 StaticVocabularyTable',
    ...
    '## Class BasicLSTMCell': '## 类 BasicLSTMCell',
    'Basic LSTM recurrent network cell.': '基本的LSTM递归网络单元。',
    '## Class BasicRNNCell': '## 类 BasicRNNCell',
    ...
    '## Class DropoutWrapper': '## 类 DropoutWrapper',
    ...
    '## Class LSTMStateTuple': '## 类 LSTMStateTuple',
    # '    h':'小时',
    '### c': '###C类',
    '### h': '### 小时',
    '## Class MultiRNNCell': '## 类 MultiRNNCell',
    'RNN cell composed sequentially of multiple simple cells.': 'RNN细胞由多个简单细胞组成。',
    '## Class ResidualWrapper': '## 类 ResidualWrapper',
    ...
    '## Class GraphNodeProto': '## 类 GraphNodeProto',
    '### children': '### 儿童',
    ...
    '## Class InputShapesEntry': '## 类 InputShapesEntry',
    'TensorShapeProto value': '张量shapeproto值',
    '## Class OpLogProto': '## 类 OpLogProto',
    '## Class IdToStringEntry': '## 类 IdToStringEntry',
    'string value': '字符串值',
    'Profile model.': '剖面模型。',
    ...
    '## Class ProfileOptionBuilder': '## 类 ProfileOptionBuilder',
    ...
    '## Class RaggedTensorValue': '## 类 RaggedTensorValue',
    ...
    '## Class FileWriterCache': '## 类 FileWriterCache',
    ...
    '## Class SummaryDescription': '## 类 SummaryDescription',
    '## Class TaggedRunMetadata': '## 类 TaggedRunMetadata',
    ...
    '## Class StubOutForTesting': '## 类 StubOutForTesting',
    ...
    '## Class CrossShardOptimizer': '## 类 CrossShardOptimizer',
    ...
    'A serialized TopologyProto that describes the TPU system. 注意：the topology must be evaluated using Session.run before it can be used.': '描述TPU系统的序列化拓扑协议。注意：必须使用session.run计算拓扑，然后才能使用它。',
    ...
    '## Class AdagradParameters': '## 类 AdagradParameters',
    ...
    '## Class AdamParameters': '## 类 AdamParameters',
    'Optimization parameters for Adam with TPU embeddings.': '带tpu嵌入的adam优化参数。',
    'Optimization parameters for Adam.': 'ADAM的优化参数。',
    '## Class StochasticGradientDescentParameters': '## 类 StochasticGradientDescentParameters',
    ...
    '## Class AdadeltaOptimizer': '## 类 AdadeltaOptimizer',
    ...
    '## Class AdagradDAOptimizer': '## 类 AdagradDAOptimizer',
    ...
    '## Class ChiefSessionCreator': '## 类 ChiefSessionCreator',
    ...
    '## Class FtrlOptimizer': '## 类 FtrlOptimizer',
    ...
    '## Class GradientDescentOptimizer': '## 类 GradientDescentOptimizer',
    ...
    '## Class LooperThread': '## 类 LooperThread',
    ...
    '## Class StepContext': '## 类 StepContext',
    '### session': '### 会议',
    'StopIteration': '停止迭代',
    ...
    '## Class ProximalAdagradOptimizer': '## 类 ProximalAdagradOptimizer',
    ...
    '## Class ProximalGradientDescentOptimizer': '## 类 ProximalGradientDescentOptimizer',
    ...
    '## Class QueueRunner': '## 类 QueueRunner',
    ...
    '## Class RMSPropOptimizer': '## 类 RMSPropOptimizer',
    ...
    '## Class SaverDef': '## 类 SaverDef',
    '### sharded': '### 切碎的',
    'CheckpointFormatVersion version': '检查点格式版本',
    '## Class Scaffold': '## 类 Scaffold',
    ...
    '## Class SessionCreator': '## 类 SessionCreator',
    'A factory for tf.Session.': '一个训练营的工厂。',
    '## Class SessionManager': '## 类 SessionManager',
    ...
    '## Class SingularMonitoredSession': '## 类 SingularMonitoredSession',
    ...
    '注意：This modified program still works fine as a single program. The single program marks itself as the chief.': '注意：这个修改过的程序仍然可以作为一个单独的程序运行。单个程序将自己标记为主任。',
    ...
    '### stop': '### 停止',
    '## Class SyncReplicasOptimizer': '## 类 SyncReplicasOptimizer',
    ...
    '## Class WorkerSessionCreator': '## 类 WorkerSessionCreator',
    ...
    '## Class MixedPrecisionLossScaleOptimizer': '## 类 MixedPrecisionLossScaleOptimizer',
    ...
    '## Class VirtualDeviceConfiguration': '## 类 VirtualDeviceConfiguration',
    ...
    '## Class DatasetSpec': '## 类 DatasetSpec',
    '## Class Options': '## 类 Options',
    ...
    '## Class CheckpointInputPipelineHook': '## 类 CheckpointInputPipelineHook',
    ...
    '## Class DistributeOptions': '## 类 DistributeOptions',
    ...
    '## Class MapVectorizationOptions': '## 类 MapVectorizationOptions',
    'Represents options for the MapVectorization optimization.': '表示地图矢量化优化的选项。',
    '### enabled': '### 启用',
    '## Class OptimizationOptions': '## 类 OptimizationOptions',
    ...
    '注意：This method takes an argument that defines the structure of the value that would be contained in the returned Optional if it had a value.': '注意：此方法接受一个参数，该参数定义了值的结构，如果该值有值，则该值将包含在返回的可选值中。',
    ...
    '## Class RandomDataset': '## 类 RandomDataset',
    'A Dataset of pseudorandom values.': '伪随机值的数据集。',
    '## Class Reducer': '## 类 Reducer',
    ...
    '## Class TFRecordWriter': '## 类 TFRecordWriter',
    ...
    '## Class ThreadingOptions': '## 类 ThreadingOptions',
    ...
    '## Class CrossDeviceOps': '## 类 CrossDeviceOps',
    ...
    '## Class HierarchicalCopyAllReduce': '## 类 HierarchicalCopyAllReduce',
    'Initializes the object.': '初始化对象。',
    '## Class InputContext': '## 类 InputContext',
    ...
    '## Class InputReplicationMode': '## 类 InputReplicationMode',
    'Replication mode for input function.': '输入功能的复制模式。',
    # '    axis':'轴',
    '## Class NcclAllReduce': '## 类 NcclAllReduce',
    ...
    '## Class ReduceOp': '## 类 ReduceOp',
    'Indicates how a set of values should be reduced.': '指示应如何减少一组值。',
    '## Class ReductionToOneDevice': '## 类 ReductionToOneDevice',
    ...
    '## Class ReplicaContext': '## 类 ReplicaContext',
    ...
    '## Class ClusterResolver': '## 类 ClusterResolver',
    ...
    '## Class GCEClusterResolver': '## 类 GCEClusterResolver',
    ...
    '## Class KubernetesClusterResolver': '## 类 KubernetesClusterResolver',
    ...
    '## Class SimpleClusterResolver': '## 类 SimpleClusterResolver',
    ...
    '## Class SlurmClusterResolver': '## 类 SlurmClusterResolver',
    ...
    '## Class TFConfigClusterResolver': '## 类 TFConfigClusterResolver',
    ...
    '## Class TPUClusterResolver': '## 类 TPUClusterResolver',
    ...
    '## Class UnionResolver': '## 类 UnionResolver',
    ...
    '## Class CentralStorageStrategy': '## 类 CentralStorageStrategy',
    '#### For Example:': '#### 例如：',
    ...
    '## Class CollectiveCommunication': '## 类 CollectiveCommunication',
    'Communication choices for CollectiveOps.': '集体行动的通讯选择。',
    '## Class MultiWorkerMirroredStrategy': '## 类 MultiWorkerMirroredStrategy',
    'A distribution strategy for synchronous training on multiple workers.': '多人同步培训的分配策略。',
    'Creates the strategy.': '创建策略。',
    '## Class ParameterServerStrategy': '## 类 ParameterServerStrategy',
    ...
    '## Class TPUStrategy': '## 类 TPUStrategy',
    ...
    '## Class AbortedError': '## 类 AbortedError',
    # '    message':'消息',
    ...
    '## Class AlreadyExistsError': '## 类 AlreadyExistsError',
    ...
    '## Class DeadlineExceededError': '## 类 DeadlineExceededError',
    ...
    '## Class FailedPreconditionError': '## 类 FailedPreconditionError',
    ...
    '## Class InternalError': '## 类 InternalError',
    ...
    '## Class OutOfRangeError': '## 类OutOfRangeError',
    ...
    '## Class PermissionDeniedError': '## 类 PermissionDeniedError',
    ...
    '## Class BestExporter': '## BestExporter',
    ...
    '## Class BinaryClassHead': '## 类 BinaryClassHead',
    ...
    '## Class BoostedTreesClassifier': '## 类 BoostedTreesClassifier',
    ...
    '## Class BoostedTreesEstimator': '## 类 BoostedTreesEstimator',
    ...
    '## Class BoostedTreesRegressor': '## 类 BoostedTreesRegressor',
    ...
    '## Class EstimatorSpec': '## 类 EstimatorSpec',
    ...
    '### hooks': '### 钩子',
    '### exporters': '### 出口商',
    '## Class Exporter': '## 类 Exporter',
    'A class representing a type of model export.': '表示模型导出类型的类。',
    '## Class FeedFnHook': '## 类 FeedFnHook',
    'Initializes a FeedFnHook.': '初始化feedfnhook。',
    '## Class FinalExporter': '## 类 FinalExporter',
    'This class exports the serving graph and checkpoints at the end.': '这个类在最后导出服务图和检查点。',
    'This class performs a single export at the end of training.': '这个类在训练结束时进行一次输出。',
    '## Class FinalOpsHook': '## 类 FinalOpsHook',
    ...
    '## Class GlobalStepWaiterHook': '## 类 GlobalStepWaiterHook',
    ...
    '## Class LatestExporter': '## 类 LatestExporter',
    ...
    '## Class PoissonRegressionHead': '## 类 PoissonRegressionHead',
    '## Class ProfilerHook': '## 类 ProfilerHook',
    ...
    '## Class RegressionHead': '## 类 RegressionHead',
    ...
    '## Class SecondOrStepTimer': '## 类 SecondOrStepTimer',
    ...
    '## Class SessionRunArgs': '## 类 SessionRunArgs',
    'Represents arguments to be added to a Session.run() call.': '表示要添加到session.run（）调用的参数。',
    '### fetches': '### 获取',
    '## Class SessionRunContext': '## 类 tSessionRunContext',
    ...
    '## Class SessionRunHook': '## 类 SessionRunHook',
    'Hook to extend calls to MonitoredSession.run().': '钩子以扩展对monitoredSession.run（）的调用。',
    '## Class SessionRunValues': '## 类 SessionRunValues',
    ...
    '### results': '### 结果',
    '## Class StepCounterHook': '## 类 StepCounterHook',
    'Hook that counts steps per second.': '每秒计算步数的钩子。',
    '## Class StopAtStepHook': '## 类 StopAtStepHook',
    ...
    # '    "cluster": {':'“群集”：{',
    '## Class VocabInfo': '## Class VocabInfo',
    # '   Example Usage:':'示例用法：',
    '### axis': '### 轴线',
    '## Class WarmStartSettings': '## 类 WarmStartSettings',
    ...
    '## Class InMemoryEvaluatorHook': '## 类 InMemoryEvaluatorHook',
    ...
    '## Class RNNClassifier': '## 类 RNNClassifier',
    ...
    '## Class RNNEstimator': '## 类 RNNEstimator',
    ...
    '## Class RegressionOutput': '## 类 RegressionOutput',
    'Represents the output of a regression head.': '表示回归头的输出。',
    'Constructor for RegressionOutput.': '用于回归输出的构造函数。',
    '## Class ServingInputReceiver': '## 类 ServingInputReceiver',
    '### features': '### 特点',
    '## Class TensorServingInputReceiver': '## 类 TensorServingInputReceiver',
    ...
    '## Class FixedLenFeature': '## 类 FixedLenFeature',
    '## Class FixedLenSequenceFeature': '## 类 FixedLenSequenceFeature',
    ...
    '注意：The order of the files returned is deterministic.': '注意：返回文件的顺序是确定的。',
    ...
    '## Class VarLenFeature': '## 类 VarLenFeature',
    ...
    '## Class LambdaCallback': '## 类 LambdaCallback',
    '## Class LearningRateScheduler': '## 类 LearningRateScheduler',
    'Learning rate scheduler.': '学习速率调度程序。',
    '## Class ModelCheckpoint': '## 类 ModelCheckpoint',
    'Save the model after every epoch.': '在每个纪元之后保存模型。',
    '## Class ProgbarLogger': '## 类 ProgbarLogger',
    'Callback that prints metrics to stdout.': '将指标打印到stdout的回调。',
    '## Class ReduceLROnPlateau': '## 类 ReduceLROnPlateau',
    'Reduce learning rate when a metric has stopped improving.': '当指标停止改善时，降低学习率。',
    '## Class RemoteMonitor': '## 类 RemoteMonitor',
    ...
    '## Class TerminateOnNaN': '## 类 TerminateOnNaN',
    'Callback that terminates training when a NaN loss is encountered.': '在遇到NaN丢失时终止训练的回调。',
    '## Class Constraint': '## 类 Constraint',
    '## Class MaxNorm': '## 类 MaxNorm',
    ...
    '## Class GlorotNormal': '## 类 GlorotNormal',
    '## Class GlorotUniform': '## 类 GlorotUniform',
    '## Class AbstractRNNCell': '## 类 AbstractRNNCell',
    'This is the base class for implementing RNN cells with custom behavior.': '这是用自定义行为实现RNN单元的基类。',
    '## Class Activation': '## 类 Activation',
    'Applies an activation function to an output.': '对输出应用激活函数。',
    '## Class ActivityRegularization': '## 类 ActivityRegularization',
    ...
    '### constraints': '### 约束条件',
    '## Class Concatenate': '## 类 Concatenate',
    ...
    '## Class Cropping3D': '## 类 Cropping3D',
    'Creates a DenseFeatures object.': '创建DenseFeatures对象。',
    '## Class DepthwiseConv2D': '## 类 DepthwiseConv2D',
    ...
    '## Class GaussianDropout': '## 类 GaussianDropout',
    '## Class GaussianNoise': '## 类 GaussianNoise',
    ...
    '## Class LayerNormalization': '## 类 LayerNormalization',
    '## Class LeakyReLU': '## 类leakyrelu',
    'Leaky version of a Rectified Linear Unit.': '校正线性单元的泄漏版本。',
    '## Class LocallyConnected1D': '## 类 LocallyConnected1D',
    'How to choose:': '如何选择：',
    '## Class LocallyConnected2D': '## 类 LocallyConnected2D',
    # '    parameters':'参数',
    '## Class Masking': '## 类 Masking',
    'Masks a sequence by using a mask value to skip timesteps.': '通过使用掩码值跳过时间步来屏蔽序列。',
    '## Class Maximum': '## 类 Maximum',
    '## Class MaxPool1D': '## 类 MaxPool1D',
    'Max pooling operation for temporal data.': '时态数据的最大池操作。',
    '## Class MaxPool2D': '## 类 MaxPool2D',
    'Max pooling operation for spatial data.': '空间数据的最大池操作。',
    '## Class MaxPool3D': '## 类 MaxPool3D',
    '## Class Minimum': '## 类 Minimum',
    '## Class Multiply': '## 类 Multiply',
    '## Class Permute': '## 类 Permute',
    ...
    '## Class KLDivergence': '## 类 KLDivergence',
    ...
    '## Class MeanAbsoluteError': '## 类 MeanAbsoluteError',
    'Computes the mean of absolute difference between labels and predictions.': '计算标签和预测之间绝对差的平均值。',
    '## Class MeanAbsolutePercentageError': '## 类 MeanAbsolutePercentageError',
    '## Class MeanSquaredError': '## 类 MeanSquaredError',
    'Computes the mean of squares of errors between labels and predictions.': '计算标签和预测之间误差平方的平均值。',
    '## Class MeanSquaredLogarithmicError': '## 类 MeanSquaredLogarithmicError',
    '## Class Poisson': '## 类 Poisson',
    '## Class SparseCategoricalCrossentropy': '## 类 SparseCategoricalCrossentropy',
    '## Class SquaredHinge': '## 类 SquaredHinge',
    'Tensor with one scalar loss entry per sample.': '每个样本有一个标量损失项的张量。',
    '## Class Accuracy': '## 类 Accuracy',
    ...
    '## Class BinaryAccuracy': '## 类 BinaryAccuracy',
    ...
    '## Class CategoricalAccuracy': '## 类 CategoricalAccuracy',
    ...
    '## Class FalseNegatives': '## 类 FalseNegatives',
    ...
    '## Class SparseCategoricalAccuracy': '## 类 SparseCategoricalAccuracy',
    'Calculates how often predictions matches integer labels.': '计算预测与整数标签匹配的频率。',
    '## Class SparseTopKCategoricalAccuracy': '## 类 SparseTopKCategoricalAccuracy',
    ...
    '## Class SpecificityAtSensitivity': '## 类 SpecificityAtSensitivity',
    ...
    '## Class TopKCategoricalAccuracy': '## 类 TopKCategoricalAccuracy',
    ...
    '## Class LossScaleOptimizer': '## 类 LossScaleOptimizer',
    ...
    '## Class Adagrad': '## 类 Adagrad',
    '#### Update step:': '#### 更新步骤：',
    '## Class Adam': '## 类 Adam',
    '## Class Adamax': '## 类 Adamax',
    ...
    '## Class ExponentialDecay': '## 类 ExponentialDecay',
    ...
    'zx: Zoom in x direction.': 'zx：沿x方向缩放。',
    ...
    '## Class DirectoryIterator': '## 类 DirectoryIterator',
    ...
    '## Class ImageDataGenerator': '## 类 ImageDataGenerator',
    # '            break':'打破',
    ...
    '## Class NumpyArrayIterator': '## 类 NumpyArrayIterator',
    ...
    '## Class TimeseriesGenerator': '## 类 TimeseriesGenerator',
    ...
    '## Class Regularizer': '## 类 Regularizer',
    ...
    '## Class CustomObjectScope': '## 类 CustomObjectScope',
    ...
    '## Class GeneratorEnqueuer': '## 类 GeneratorEnqueuer',
    ...
    '## Class SequenceEnqueuer': '## 类 SequenceEnqueuer',
    ...
    '## Class KerasClassifier': '## 类 KerasClassifier',
    ...
    '## Class KerasRegressor': '## 类 KerasRegressor',
    ...
    '注意：The gradient computation on GPU is faster for large matrices but not for large batch dimensions when the submatrices are small. In this case it might be faster to use the CPU.': '注：对于大型矩阵，GPU上的梯度计算速度更快，但对于子矩阵较小的大批量尺寸，则不是如此。在这种情况下，使用CPU可能更快。',
    ...
    '## Class LinearOperator': '## 类 LinearOperator',
    ...
    '## Class LinearOperatorAdjoint': '## 类 LinearOperatorAdjoint',
    ...
    '## Class LinearOperatorBlockDiag': '## 类 LinearOperatorBlockDiag',
    ...
    '### operators': '### 操作员',
    '## Class LinearOperatorCirculant': '## 类 LinearOperatorCirculant',
    ...
    '## Class LinearOperatorCirculant2D': '## 类 LinearOperatorCirculant2D',
    ...
    '## Class LinearOperatorCirculant3D': '## 类 LinearOperatorCirculant3D',
    ...
    '## Class LinearOperatorComposition': '## 类 LinearOperatorComposition',
    ...
    '## Class LinearOperatorDiag': '## 类 LinearOperatorDiag',
    ...
    '### diag': '### 诊断',
    '## Class LinearOperatorFullMatrix': '## 类 LinearOperatorFullMatrix',
    ...
    '## Class LinearOperatorHouseholder': '## 类 LinearOperatorHouseholder',
    ...
    '## Class LinearOperatorIdentity': '## 类 LinearOperatorIdentity',
    ...
    '## Class LinearOperatorInversion': '## 类 LinearOperatorInversion',
    ...
    '## Class LinearOperatorKronecker': '## 类 LinearOperatorKronecker',
    ...
    '## Class LinearOperatorLowerTriangular': '## 类 LinearOperatorLowerTriangular',
    ...
    '## Class LinearOperatorLowRankUpdate': '## 类 LinearOperatorLowRankUpdate',
    ...
    '### u': '###U型',
    '### v': '### 五',
    '## Class LinearOperatorScaledIdentity': '## 类 LinearOperatorScaledIdentity',
    ...
    '### multiplier': '### 乘数',
    '## Class LinearOperatorToeplitz': '## 类 LinearOperatorToeplitz',
    ...
    '### col': '### col列',
    '### row': '### 行',
    '## Class LinearOperatorZeros': '## 类 LinearOperatorZeros',
    ...
    '## Class Interpreter': '## 类 Interpreter',
    ...
    '## Class KeyValueTensorInitializer': '## 类KeyValueTensorInitializer',
    ...
    '## Class TextFileIndex': '## 类 TextFileIndex',
    ...
    '## Class TextFileInitializer': '## 类 TextFileInitializer',
    ...
    '## Class DenseHashTable': '## 类 DenseHashTable',
    ...
    '## Class RNNCellDeviceWrapper': '## 类 RNNCellDeviceWrapper',
    '## Class RNNCellDropoutWrapper': '## 类 RNNCellDropoutWrapper',
    '## Class RNNCellResidualWrapper': '## 类 RNNCellResidualWrapper',
    ...
    '## Class SparseTensor': '## 类 SparseTensor',
    ...
    '## Class SummaryWriter': '## Class SummaryWriter',
    ...
    '## Class DeviceAssignment': '## 类 DeviceAssignment',
    ...
    '## Class BytesList': '## 类 BytesList',
    'repeated bytes value': '重复字节值',
    '## Class CheckpointManager': '## 类 CheckpointManager',
    ...
    '## Class ClusterDef': '## 类 ClusterDef',
    'repeated JobDef job': '重复作业定义作业',
    '## Class ClusterSpec': '## 类 ClusterSpec',
    ...
    '## Class ExponentialMovingAverage': '##ExponentialMovingAverage',
    ...
    '## Class SequenceExample': '## 类 SequenceExample',
    '### context': '### 上下文',
    'Features context': '功能上下文',
    '## Class ServerDef': '## 类 ServerDef',
    'ClusterDef cluster': 'clusterDef群集',
    'string protocol': '字符串协议',
    '## Class DynamicLossScale': '## 类 DynamicLossScale',
    ...
    '## Class FixedLossScale': '## 类 FixedLossScale',
    ...
    '注意：This is an experimental feature.': '注：这是一个实验特性。',
