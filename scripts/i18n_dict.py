i18n_dict = {
    ...
    '注意：This constructor validates the given name. Valid scope names match one of the following regular expressions:': '',
    ...
    '注意：Prefer using the Tensor division operator or tf.divide which obey Python 3 division operator semantics.': '',
    ...
    '注意：Prefer using the Tensor operator or tf.divide which obey Python division operator semantics.': '',
    ...
    '注意：This is an escape hatch for existing uses of filter that do not work with V2 functions. New uses are strongly discouraged and existing uses should migrate to filter as this method will be removed in V2.': '',
    'Creates a Dataset whose elements are generated by generator.': '',
    'Creates a Dataset whose elements are slices of the given tensors.': '',
    '### interleave': '',
    'A dataset of all files matching one or more glob patterns.': '',
    '### map': '',
    '注意：This is an escape hatch for existing uses of map that do not work with V2 functions. New uses are strongly discouraged and existing uses should migrate to map as this method will be removed in V2.': '',
    '### options': '',
    ...
    '注意：MUST mirror the behavior of the C++ AppendFlagsIntoFile from https://github.com/gflags/gflags.': '',
    ...
    '注意：MUST mirror the behavior of the C++ CommandlineFlagsIntoString from https://github.com/gflags/gflags.': '',
    ...
    '注意：This method takes an argument that defines the structure of the value that would be contained in the returned Optional if it had a value.': '',
    ...
    '注意：The order of the files returned is deterministic.': '',
    ...
    '注意：The gradient computation on GPU is faster for large matrices but not for large batch dimensions when the submatrices are small. In this case it might be faster to use the CPU.': '',
    ...
    '注意：This is an experimental feature.': '',
    '## Primary symbols': '',
    '## Compat v2 symbols': '',
    '## Compat v1 symbols': ''
}
