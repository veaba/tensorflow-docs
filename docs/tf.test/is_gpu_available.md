...
<aside class="warning">**Warning:**  if a non-GPU version of the package is installed, the function would
also return False. Use [ `tf.test.is_built_with_cuda` ](https://tensorflow.google.cn/api_docs/python/tf/test/is_built_with_cuda) to validate if TensorFlow
was build with CUDA support.</aside>
