...
version](/versions/r1.15/api_docs/python/tf/test/create_local_cluster) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/test_util.py#L2947-L3034)  
...
Figure illustrates the interaction of these components. "/job:worker/task:0"
and "/job:ps/task:0" are both tasks with worker services.
...
#### Args:
  ...
  * **`protocol`** : Communication protocol. Allowed values are documented in the documentation of [`tf.distribute.Server`](https://tensorflow.google.cn/api_docs/python/tf/distribute/Server).
...
A tuple `(worker_servers, ps_servers)`. `worker_servers` is a list of
`num_workers` objects of type
[`tf.distribute.Server`](https://tensorflow.google.cn/api_docs/python/tf/distribute/Server)
(all running locally); and `ps_servers` is a list of `num_ps` objects of
similar type.
