...
**别名** : [ `tf.compat.v1.test.create_local_cluster` ](/api_docs/python/tf/test/create_local_cluster), [ `tf.compat.v2.test.create_local_cluster` ](/api_docs/python/tf/test/create_local_cluster)
...
更多信息请访问https://www.tensorflow.org/guide/extend/architecture
