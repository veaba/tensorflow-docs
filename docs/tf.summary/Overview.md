...
[tf.summary](https://www.tensorflow.org/api_docs/python/tf/summary)The  module provides APIs for writing summary data. This data can be visualized in TensorBoard, the visualization toolkit that comes with TensorFlow. See the TensorBoard website for more detailed tutorials about how to use these APIs, or some quick examples below.
...
with writer.as_default():
  for step in range(100):
    ...
    writer.flush()
```
[tf.function](https://www.tensorflow.org/api_docs/python/tf/function)Example usage with  graph execution:
...
```
## Modules
[experimental](https://www.tensorflow.org/api_docs/python/tf/summary/experimental) module: Public API for tf.summary. namespace.
