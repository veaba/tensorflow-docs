...
[tf.SparseTensor](https://www.tensorflow.org/api_docs/python/tf/sparse/SparseTensor)Type specification for a .
...
```
[tf.SparseTensor](https://www.tensorflow.org/api_docs/python/tf/sparse/SparseTensor)Constructs a type specification for a .
...
## Properties
### dtype
[tf.dtypes.DType](https://www.tensorflow.org/api_docs/python/tf/dtypes/DType)The  specified by this type for the SparseTensor.

### shape
[tf.TensorShape](https://www.tensorflow.org/api_docs/python/tf/TensorShape)The  specified by this type for the SparseTensor.
