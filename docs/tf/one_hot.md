...
version](/versions/r1.15/api_docs/python/tf/one_hot) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/array_ops.py#L3371-L3514)  
...
([`tf.string`](https://tensorflow.google.cn/api_docs/python/tf#string),
[`tf.bool`](https://tensorflow.google.cn/api_docs/python/tf#bool), etc.), both
`on_value` and `off_value` _must_ be provided to `one_hot`.
