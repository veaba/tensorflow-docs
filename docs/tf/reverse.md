...
```
[tf.reverse](https://www.tensorflow.org/api_docs/python/tf/reverse)NOTE  has now changed behavior in preparation for 1.0. _v2 is currently an alias that will be deprecated before TF 1.0.
