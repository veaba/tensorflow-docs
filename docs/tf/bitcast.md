...
version](/versions/r1.15/api_docs/python/tf/bitcast)  
---  
...
_NOTE_ : Bitcast is implemented as a low-level cast, so machines with
different endian orderings will give different results.
