...
```
## Modules
[audio](https://www.tensorflow.org/api_docs/python/tf/audio) module: Public API for tf. namespace.

[autograph](https://www.tensorflow.org/api_docs/python/tf/autograph) module: Conversion of plain Python into TensorFlow graph code.

[bitwise](https://www.tensorflow.org/api_docs/python/tf/bitwise) module: Operations for manipulating the binary representations of integers.

[compat](https://www.tensorflow.org/api_docs/python/tf/compat) module: Functions for Python 2 vs. 3 ibility.

[config](https://www.tensorflow.org/api_docs/python/tf/config) module: Public API for tf. namespace.

[data](https://www.tensorflow.org/api_docs/python/tf/data) module: tf..Dataset API for input pipelines.

[debugging](https://www.tensorflow.org/api_docs/python/tf/debugging) module: Public API for tf. namespace.

[distribute](https://www.tensorflow.org/api_docs/python/tf/distribute) module: Library for running a computation across multiple devices.

[dtypes](https://www.tensorflow.org/api_docs/python/tf/dtypes) module: Public API for tf. namespace.

[errors](https://www.tensorflow.org/api_docs/python/tf/errors) module: Exception types for TensorFlow .

[estimator](https://www.tensorflow.org/api_docs/python/tf/estimator) module: Estimator: High level tools for working with models.

[experimental](https://www.tensorflow.org/api_docs/python/tf/experimental) module: Public API for tf. namespace.

[feature_column](https://www.tensorflow.org/api_docs/python/tf/feature_column) module: Public API for tf. namespace.

[graph_util](https://www.tensorflow.org/api_docs/python/tf/graph_util) module: Helpers to manipulate a tensor graph in python.

[image](https://www.tensorflow.org/api_docs/python/tf/image) module: Image processing and decoding ops.

[initializers](https://www.tensorflow.org/api_docs/python/tf/initializers) module: Keras initializer serialization / deserialization.

[io](https://www.tensorflow.org/api_docs/python/tf/io) module: Public API for tf. namespace.

[keras](https://www.tensorflow.org/api_docs/python/tf/keras) module: Implementation of the Keras API meant to be a high-level API for TensorFlow.

[linalg](https://www.tensorflow.org/api_docs/python/tf/linalg) module: Operations for linear algebra.

[lite](https://www.tensorflow.org/api_docs/python/tf/lite) module: Public API for tf. namespace.

[lookup](https://www.tensorflow.org/api_docs/python/tf/lookup) module: Public API for tf. namespace.

[losses](https://www.tensorflow.org/api_docs/python/tf/losses) module: Built-in loss functions.

[math](https://www.tensorflow.org/api_docs/python/tf/math) module: Math Operations.

[metrics](https://www.tensorflow.org/api_docs/python/tf/metrics) module: Built-in .

[nest](https://www.tensorflow.org/api_docs/python/tf/nest) module: Public API for tf. namespace.

[nn](https://www.tensorflow.org/api_docs/python/tf/nn) module: Wrappers for primitive Neural Net (NN) Operations.

[optimizers](https://www.tensorflow.org/api_docs/python/tf/optimizers) module: Built-in optimizer classes.

[quantization](https://www.tensorflow.org/api_docs/python/tf/quantization) module: Public API for tf. namespace.

[queue](https://www.tensorflow.org/api_docs/python/tf/queue) module: Public API for tf. namespace.

[ragged](https://www.tensorflow.org/api_docs/python/tf/ragged) module: Ragged Tensors.

[random](https://www.tensorflow.org/api_docs/python/tf/random) module: Public API for tf. namespace.

[raw_ops](https://www.tensorflow.org/api_docs/python/tf/raw_ops) module: Public API for tf. namespace.

[saved_model](https://www.tensorflow.org/api_docs/python/tf/saved_model) module: Public API for tf. namespace.

[sets](https://www.tensorflow.org/api_docs/python/tf/sets) module: Tensorflow set operations.

[signal](https://www.tensorflow.org/api_docs/python/tf/signal) module: Signal processing operations.

[sparse](https://www.tensorflow.org/api_docs/python/tf/sparse) module: Sparse Tensor Representation.

[strings](https://www.tensorflow.org/api_docs/python/tf/strings) module: Operations for working with string Tensors.

[summary](https://www.tensorflow.org/api_docs/python/tf/summary) module: Operations for writing  data, for use in analysis and visualization.

[sysconfig](https://www.tensorflow.org/api_docs/python/tf/sysconfig) module: System configuration library.

[test](https://www.tensorflow.org/api_docs/python/tf/test) module: Testing.

[tpu](https://www.tensorflow.org/api_docs/python/tf/tpu) module: Ops related to Tensor Processing Units.

[train](https://www.tensorflow.org/api_docs/python/tf/train) module: Support for ing models.

[version](https://www.tensorflow.org/api_docs/python/tf/version) module: Public API for tf. namespace.

[xla](https://www.tensorflow.org/api_docs/python/tf/xla) module: Public API for tf. namespace.
...
[class Variable](https://www.tensorflow.org/api_docs/python/tf/Variable): See the Variables Guide.
...
[constant(...)](https://www.tensorflow.org/api_docs/python/tf/constant): Creates a constant tensor.
...
[expand_dims(...)](https://www.tensorflow.org/api_docs/python/tf/expand_dims): Inserts a dimension of 1 into a tensor's shape.
...
[ones_like(...)](https://www.tensorflow.org/api_docs/python/tf/ones_like): Creates a tensor with all elements set to one.
...
[reduce_all(...)](https://www.tensorflow.org/api_docs/python/tf/reduce_all): Computes the "logical and" of elements across dimensions of a tensor.
...
[shape(...)](https://www.tensorflow.org/api_docs/python/tf/shape): Returns the shape of a tensor.
...
[transpose(...)](https://www.tensorflow.org/api_docs/python/tf/transpose): Transposes a.
...
[where(...)](https://www.tensorflow.org/api_docs/python/tf/where): Return the elements, either from x or y, depending on the condition.

[while_loop(...)](https://www.tensorflow.org/api_docs/python/tf/while_loop): Repeat body while the condition cond is true.
