...
version](/versions/r1.15/api_docs/python/tf/foldr) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/functional_ops.py#L162-L277)  
...
`fn` consecutively to the list of tensors unpacked from `elems`, from last to
first.
