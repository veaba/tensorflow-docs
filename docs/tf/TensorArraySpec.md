...
[tf.TensorArray](https://tensorflow.google.cn/api_docs/python/tf/TensorArray)Type specification for a .
...
```
[tf.TensorArray](https://tensorflow.google.cn/api_docs/python/tf/TensorArray)Constructs a type specification for a .
