...
```
[tf.compat.v1.squeeze](https://www.tensorflow.org/api_docs/python/tf/compat/v1/squeeze)Unlike the older op , this op does not accept a deprecated squeeze_dims argument.
