...
[tf.Tensor](https://www.tensorflow.org/api_docs/python/tf/Tensor)Metadata for describing the  objects accepted or returned by some TensorFlow APIs.
...
[tf.TensorShape.is_compatible_with](https://www.tensorflow.org/api_docs/python/tf/TensorShape#is_compatible_with)Two tensors are considered compatible if they have the same dtype and their shapes are compatible (see ).
