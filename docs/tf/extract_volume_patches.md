...
>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""> `&nbsp; &nbsp; &nbsp; ksizes = [1, ksize_planes, ksize_rows, ksize_cols, 1]<br>&nbsp; &nbsp; &nbsp; strides = [1, stride_planes, strides_rows, strides_cols, 1]<br>` </pre></devsite-code>
