...
[tf.TypeSpec](https://www.tensorflow.org/api_docs/python/tf/TypeSpec)A  provides metadata describing an object accepted or returned by TensorFlow APIs. Concrete subclasses, such as tf.TensorSpec and tf.RaggedTensorSpec, are used to describe different value types.

[tf.function](https://www.tensorflow.org/api_docs/python/tf/function)For example, 's input_signature argument accepts a list (or nested structure) of TypeSpecs.
