...
[tf.IndexedSlices](https://www.tensorflow.org/api_docs/python/tf/IndexedSlices)Type specification for a .

[TypeSpec](https://www.tensorflow.org/api_docs/python/tf/TypeSpec)Inherits From: 
...
```
[tf.IndexedSlices](https://www.tensorflow.org/api_docs/python/tf/IndexedSlices)Constructs a type specification for a .
...
- `indices`_`shape`: The `shape` of the `indices` component, which indicates how many slices are in the `IndexedSlices`.
## Properties
### value_type
## Methods
### __eq__
