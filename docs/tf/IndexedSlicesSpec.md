...
[tf.IndexedSlices](https://tensorflow.google.cn/api_docs/python/tf/IndexedSlices)Type specification for a .
...
```
[tf.IndexedSlices](https://tensorflow.google.cn/api_docs/python/tf/IndexedSlices)Constructs a type specification for a .
