...
version](/versions/r1.15/api_docs/python/tf/concat) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/array_ops.py#L1337-L1431)  
---|---  
...
`values[i].shape = [D0, D1, ... Daxis(i), ...Dn]`, the concatenated result has
shape
