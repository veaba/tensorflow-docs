...
**Aliases** : [ `tf.compat.v1.control_dependencies` ](/api_docs/python/tf/control_dependencies), [ `tf.compat.v2.control_dependencies` ](/api_docs/python/tf/control_dependencies)
