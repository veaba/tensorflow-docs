...
version](/versions/r1.15/api_docs/python/tf/math/reduce_euclidean_norm) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/math_ops.py#L1578-L1616)  
---|---  
