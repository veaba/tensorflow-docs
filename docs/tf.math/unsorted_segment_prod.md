...
[(here)](https://www.tensorflow.org/api_docs/api_docs/python/math_ops#UnsortedSegmentSum)This operator is similar to the unsorted segment sum operator found . Instead of computing the sum over segments, it computes the product of all entries belonging to a segment such that:
