...
**Aliases** : [ `tf.compat.v1.math.square` ](/api_docs/python/tf/math/square), [ `tf.compat.v1.square` ](/api_docs/python/tf/math/square), [ `tf.compat.v2.math.square` ](/api_docs/python/tf/math/square), [ `tf.compat.v2.square` ](/api_docs/python/tf/math/square), [ `tf.square` ](/api_docs/python/tf/math/square)
