...
<em>NOTE</em>: [ `math.squared_difference` ](https://tensorflow.google.cn/api_docs/python/tf/math/squared_difference) supports broadcasting. More about broadcasting
