...
**Aliases** : [ `tf.argmin` ](/api_docs/python/tf/math/argmin), [ `tf.compat.v2.argmin` ](/api_docs/python/tf/math/argmin), [ `tf.compat.v2.math.argmin` ](/api_docs/python/tf/math/argmin)
