...
**Aliases** : [ `tf.compat.v1.math.segment_sum` ](/api_docs/python/tf/math/segment_sum), [ `tf.compat.v1.segment_sum` ](/api_docs/python/tf/math/segment_sum), [ `tf.compat.v2.math.segment_sum` ](/api_docs/python/tf/math/segment_sum)
...
Computes a tensor such that\(output_i = \sum_j data_j\) where sum is over  `j`  suchthat  `segment_ids[j] == i` .
