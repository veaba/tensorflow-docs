...
**别名** : [ `tf.compat.v1.imag` ](/api_docs/python/tf/math/imag), [ `tf.compat.v1.math.imag` ](/api_docs/python/tf/math/imag), [ `tf.compat.v2.math.imag` ](/api_docs/python/tf/math/imag)
