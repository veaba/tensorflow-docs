...
[here](https://www.tensorflow.org/api_docs/api_docs/python/math_ops#UnsortedSegmentSum)This operator is similar to the unsorted segment sum operator found . Additionally to computing the sum over segments, it divides the results by sqrt(N).
