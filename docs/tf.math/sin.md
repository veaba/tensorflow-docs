...
version](/versions/r1.15/api_docs/python/tf/math/sin)  
---  
...
>
>     x = tf.constant([-float("inf"), -9, -0.5, 1, 1.2, 200, 10,
> float("inf")])
>     tf.math.sin(x) ==> [nan -0.4121185 -0.47942555 0.84147096 0.9320391
> -0.87329733 -0.54402107 nan]
>  
