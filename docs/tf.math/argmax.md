...
**Aliases** : [ `tf.argmax` ](/api_docs/python/tf/math/argmax), [ `tf.compat.v2.argmax` ](/api_docs/python/tf/math/argmax), [ `tf.compat.v2.math.argmax` ](/api_docs/python/tf/math/argmax)
