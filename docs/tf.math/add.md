...
**Aliases** : [ `tf.add` ](/api_docs/python/tf/math/add), [ `tf.compat.v1.add` ](/api_docs/python/tf/math/add), [ `tf.compat.v1.math.add` ](/api_docs/python/tf/math/add), [ `tf.compat.v2.add` ](/api_docs/python/tf/math/add), [ `tf.compat.v2.math.add` ](/api_docs/python/tf/math/add)
