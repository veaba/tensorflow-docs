...
**Aliases** : [ `tf.compat.v1.estimator.BoostedTreesClassifier` ](/api_docs/python/tf/estimator/BoostedTreesClassifier), [ `tf.compat.v2.estimator.BoostedTreesClassifier` ](/api_docs/python/tf/estimator/BoostedTreesClassifier)
