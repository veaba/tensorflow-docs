...
version](/versions/r1.15/api_docs/python/tf/estimator/LinearRegressor) |  [
...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.LinearRegressor`](/api_docs/python/tf/estimator/LinearRegressor)
...
#### Args:
  ...
  * **`loss_reduction`** : One of [`tf.losses.Reduction`](https://tensorflow.google.cn/api_docs/python/tf/keras/losses/Reduction) except `NONE`. Describes how to reduce training loss over batch. Defaults to `SUM`.
