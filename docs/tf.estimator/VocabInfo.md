...
[tf.estimator.WarmStartSettings](https://tensorflow.google.cn/api_docs/python/tf/estimator/WarmStartSettings)See  for examples of using VocabInfo to warm-start.
