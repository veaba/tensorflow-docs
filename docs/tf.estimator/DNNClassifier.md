...
version](/versions/r1.15/api_docs/python/tf/estimator/DNNClassifier) |  [
...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.DNNClassifier`](/api_docs/python/tf/estimator/DNNClassifier)
