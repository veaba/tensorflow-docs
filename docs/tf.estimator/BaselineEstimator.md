...
version](/versions/r1.15/api_docs/python/tf/estimator/BaselineEstimator) |  [
...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.BaselineEstimator`](/api_docs/python/tf/estimator/BaselineEstimator)
