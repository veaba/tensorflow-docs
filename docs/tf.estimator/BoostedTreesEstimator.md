...
**Aliases** : [ `tf.compat.v1.estimator.BoostedTreesEstimator` ](/api_docs/python/tf/estimator/BoostedTreesEstimator), [ `tf.compat.v2.estimator.BoostedTreesEstimator` ](/api_docs/python/tf/estimator/BoostedTreesEstimator)
