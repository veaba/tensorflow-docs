...
- Class [ `tf.compat.v1.estimator.MultiHead` ](/api_docs/python/tf/estimator/MultiHead)

- Class [ `tf.compat.v2.estimator.MultiHead` ](/api_docs/python/tf/estimator/MultiHead)
