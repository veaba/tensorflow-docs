...
- Class [ `tf.compat.v2.estimator.DNNLinearCombinedEstimator` ](/api_docs/python/tf/estimator/DNNLinearCombinedEstimator)
...
will use [ `tf.nn.relu` ](https://tensorflow.google.cn/api_docs/python/tf/nn/relu).
