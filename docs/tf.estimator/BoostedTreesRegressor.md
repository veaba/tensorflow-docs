...
Tensorflow 增强树模型的回归器。

**别名** : [ `tf.compat.v1.estimator.BoostedTreesRegressor` ](/api_docs/python/tf/estimator/BoostedTreesRegressor), [ `tf.compat.v2.estimator.BoostedTreesRegressor` ](/api_docs/python/tf/estimator/BoostedTreesRegressor)
