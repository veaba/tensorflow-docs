...
version](/versions/r1.15/api_docs/python/tf/estimator/PoissonRegressionHead) |
...
#### Args:
  ...
  * **`compute_full_loss`** : Whether to include the constant `log(z!)` term in computing the poisson loss. See [`tf.nn.log_poisson_loss`](https://tensorflow.google.cn/api_docs/python/tf/nn/log_poisson_loss) for the full documentation.
