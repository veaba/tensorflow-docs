...
**别名** : [ `tf.compat.v1.estimator.PoissonRegressionHead` ](/api_docs/python/tf/estimator/PoissonRegressionHead), [ `tf.compat.v2.estimator.PoissonRegressionHead` ](/api_docs/python/tf/estimator/PoissonRegressionHead)
