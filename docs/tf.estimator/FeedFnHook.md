...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/basic_session_run_hooks.py#L971-L985)  
---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.estimator.FeedFnHook`](/api_docs/python/tf/estimator/FeedFnHook)
  * Class [`tf.compat.v1.train.FeedFnHook`](/api_docs/python/tf/estimator/FeedFnHook)
  * Class [`tf.compat.v2.estimator.FeedFnHook`](/api_docs/python/tf/estimator/FeedFnHook)

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/basic_session_run_hooks.py#L974-L981)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/basic_session_run_hooks.py#L983-L985)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/session_run_hook.py#L101-L110)
