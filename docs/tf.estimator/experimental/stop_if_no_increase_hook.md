...
version](/versions/r1.15/api_docs/python/tf/estimator/experimental/stop_if_no_increase_hook)
...
### Aliases:
  ...
  * [`tf.compat.v1.estimator.experimental.stop_if_no_increase_hook`](/api_docs/python/tf/estimator/experimental/stop_if_no_increase_hook)
  * [`tf.compat.v2.estimator.experimental.stop_if_no_increase_hook`](/api_docs/python/tf/estimator/experimental/stop_if_no_increase_hook)
...
the given metric shows no increase over given maximum number of training
