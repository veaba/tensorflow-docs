...
**Aliases** : [ `tf.compat.v1.estimator.experimental.make_early_stopping_hook` ](/api_docs/python/tf/estimator/experimental/make_early_stopping_hook), [ `tf.compat.v2.estimator.experimental.make_early_stopping_hook` ](/api_docs/python/tf/estimator/experimental/make_early_stopping_hook)
