...
version](/versions/r1.15/api_docs/python/tf/estimator/experimental/stop_if_lower_hook)
...
### Aliases:
  ...
  * [`tf.compat.v1.estimator.experimental.stop_if_lower_hook`](/api_docs/python/tf/estimator/experimental/stop_if_lower_hook)
  * [`tf.compat.v2.estimator.experimental.stop_if_lower_hook`](/api_docs/python/tf/estimator/experimental/stop_if_lower_hook)
...
the given metric is lower than specified threshold and initiates early
stopping if true.
