...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.experimental.RNNClassifier`](/api_docs/python/tf/estimator/experimental/RNNClassifier)
...
Note that a RNN cell has: \- a `call` method. \- a `state_size` attribute. \-
