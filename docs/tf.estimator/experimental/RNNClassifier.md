...
[RNNEstimator](https://tensorflow.google.cn/api_docs/python/tf/estimator/experimental/RNNEstimator)Inherits From: 
...
[tf.keras.layers.RNN](https://tensorflow.google.cn/api_docs/python/tf/keras/layers/RNN)Note that a RNN cell has: - a call method. - a state_size attribute. - a output_size attribute. - a get_initial_state method. See the documentation on  for more details.
