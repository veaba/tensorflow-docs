...
- **`optimizer`** : An instance of [ `tf.keras.optimizers.Optimizer` ](https://tensorflow.google.cn/api_docs/python/tf/keras/optimizers/Optimizer) used to train
...
use [ `tf.nn.relu` ](https://tensorflow.google.cn/api_docs/python/tf/nn/relu).
