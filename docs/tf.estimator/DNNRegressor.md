...
version](/versions/r1.15/api_docs/python/tf/estimator/DNNRegressor) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/canned/dnn.py)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.DNNRegressor`](/api_docs/python/tf/estimator/DNNRegressor)
...
[View
source](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/canned/dnn.py)
...
#### Args:
  ...
  * **`optimizer`** : An instance of [`tf.keras.optimizers.Optimizer`](https://tensorflow.google.cn/api_docs/python/tf/keras/optimizers/Optimizer) used to train the model. Can also be a string (one of 'Adagrad', 'Adam', 'Ftrl', 'RMSProp', 'SGD'), or callable. Defaults to Adagrad optimizer.
  * **`activation_fn`** : Activation function applied to each layer. If `None`, will use [`tf.nn.relu`](https://tensorflow.google.cn/api_docs/python/tf/nn/relu).
