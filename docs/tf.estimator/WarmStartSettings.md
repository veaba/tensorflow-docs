...
version](/versions/r1.15/api_docs/python/tf/estimator/WarmStartSettings) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/estimator.py)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.estimator.WarmStartSettings`](/api_docs/python/tf/estimator/WarmStartSettings)
  * Class [`tf.compat.v2.estimator.WarmStartSettings`](/api_docs/python/tf/estimator/WarmStartSettings)

Example Use with canned
...
Warm-start all weights in the model (input layer and hidden weights). Either
the directory or a specific checkpoint can be provided (in the case of the
former, the latest checkpoint will be used):
...
Create new instance of WarmStartSettings(ckpt_to_initialize_from,
