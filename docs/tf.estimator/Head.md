...
>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""> `def)(inputs)<br>&nbsp;)(hidden_layer0)<br>&nbsp;))<br>&nbsp;))<br>&nbsp; model.add(tf.keras.layers.Dense(<br>&nbsp; &nbsp; &nbsp;units=head.logits_dimension, activation=None))<br>&nbsp; logits = model(inputs)<br><br>&nbsp; return head.create_estimator_spec(<br>&nbsp; &nbsp; &nbsp; features=features,<br>&nbsp; &nbsp; &nbsp; labels=labels,<br>&nbsp; &nbsp; &nbsp; mode=mode,<br>&nbsp; &nbsp; &nbsp; logits=logits,<br>&nbsp; &nbsp; &nbsp; optimizer=optimizer)<br>` </pre></devsite-code>
