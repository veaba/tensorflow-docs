...
version](/versions/r1.15/api_docs/python/tf/estimator/LinearEstimator) |  [
...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.LinearEstimator`](/api_docs/python/tf/estimator/LinearEstimator)
