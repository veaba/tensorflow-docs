...
**Aliases** : [ `tf.compat.v1.estimator.SessionRunHook` ](/api_docs/python/tf/estimator/SessionRunHook), [ `tf.compat.v1.train.SessionRunHook` ](/api_docs/python/tf/estimator/SessionRunHook), [ `tf.compat.v2.estimator.SessionRunHook` ](/api_docs/python/tf/estimator/SessionRunHook)
