...
## Class  `NanTensorHook` 
监测损失张量，如果损失为NaN，则停止训练。

Inherits From: [ `SessionRunHook` ](https://tensorflow.google.cn/api_docs/python/tf/estimator/SessionRunHook)

**别名** : [ `tf.compat.v1.estimator.NanTensorHook` ](/api_docs/python/tf/estimator/NanTensorHook), [ `tf.compat.v1.train.NanTensorHook` ](/api_docs/python/tf/estimator/NanTensorHook), [ `tf.compat.v2.estimator.NanTensorHook` ](/api_docs/python/tf/estimator/NanTensorHook)
