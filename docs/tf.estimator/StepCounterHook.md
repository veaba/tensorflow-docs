...
**Aliases** : [ `tf.compat.v1.estimator.StepCounterHook` ](/api_docs/python/tf/estimator/StepCounterHook), [ `tf.compat.v1.train.StepCounterHook` ](/api_docs/python/tf/estimator/StepCounterHook), [ `tf.compat.v2.estimator.StepCounterHook` ](/api_docs/python/tf/estimator/StepCounterHook)
