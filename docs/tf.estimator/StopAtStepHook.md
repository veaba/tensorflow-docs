...
**Aliases** : [ `tf.compat.v1.estimator.StopAtStepHook` ](/api_docs/python/tf/estimator/StopAtStepHook), [ `tf.compat.v1.train.StopAtStepHook` ](/api_docs/python/tf/estimator/StopAtStepHook), [ `tf.compat.v2.estimator.StopAtStepHook` ](/api_docs/python/tf/estimator/StopAtStepHook)
