...
**别名** : [ `tf.compat.v1.estimator.LatestExporter` ](/api_docs/python/tf/estimator/LatestExporter), [ `tf.compat.v2.estimator.LatestExporter` ](/api_docs/python/tf/estimator/LatestExporter)
