...
version](/versions/r1.15/api_docs/python/tf/estimator/BinaryClassHead) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/head/binary_class_head.py)  
---|---  
...
The head expects `logits` with shape `[D0, D1, ... DN, 1]`. In many
...
[View
source](https://github.com/tensorflow/estimator/tree/master/tensorflow_estimator/python/estimator/head/binary_class_head.py)
