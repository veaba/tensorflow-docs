...
- Class [ `tf.compat.v1.estimator.BinaryClassHead` ](/api_docs/python/tf/estimator/BinaryClassHead)

- Class [ `tf.compat.v2.estimator.BinaryClassHead` ](/api_docs/python/tf/estimator/BinaryClassHead)
