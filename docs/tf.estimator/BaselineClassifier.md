...
version](/versions/r1.15/api_docs/python/tf/estimator/BaselineClassifier) |  [
...
### Aliases:
  ...
  * Class [`tf.compat.v2.estimator.BaselineClassifier`](/api_docs/python/tf/estimator/BaselineClassifier)
