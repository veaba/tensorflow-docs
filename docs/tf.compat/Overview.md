...
- `real_types`
## Modules
[v1](https://www.tensorflow.org/api_docs/python/tf/compat/v1) module: Bring in all of the public TensorFlow interface into this module.

[v2](https://www.tensorflow.org/api_docs/python/tf/compat/v2) module: Bring in all of the public TensorFlow interface into this module.
