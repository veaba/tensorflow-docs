...
Inherits From: [ `AveragePooling3D` ](https://tensorflow.google.cn/api_docs/python/tf/keras/layers/AveragePooling3D), [ `Layer` ](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/layers/Layer)
