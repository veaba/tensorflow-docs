...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/layers/pooling.py#L274-L311)  
---  
...
version. Instructions for updating: Use keras.layers.MaxPooling2D instead.
