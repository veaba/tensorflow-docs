...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/layers/pooling.py#L61-L95)  
---  
...
version. Instructions for updating: Use keras.layers.AveragePooling1D instead.
