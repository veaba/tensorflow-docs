...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/layers/pooling.py#L426-L463)  
---  
...
version. Instructions for updating: Use keras.layers.MaxPooling3D instead.
