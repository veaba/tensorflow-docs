...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/layers/pooling.py#L131-L165)  
---  
...
version. Instructions for updating: Use keras.layers.MaxPooling1D instead.
