Gets an existing <em>local</em> variable or creates a new one.
...
Defaults to  `[GraphKeys.LOCAL_VARIABLES]`  (see [ `tf.Variable` ](https://tensorflow.google.cn/api_docs/python/tf/Variable)).
...
>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""> `def custom_getter(getter, name, *args, **kwargs):<br>&nbsp; return getter(name + '_suffix', *args, **kwargs)<br>` </pre></devsite-code>
