...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/distributions/laplace.py#L47-L217)  
---  
...
The Lpalce distribution is a member of the [location-scale
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/distributions/laplace.py#L75-L126)
