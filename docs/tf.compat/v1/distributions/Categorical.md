...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/distributions/categorical.py#L63-L325)  
---  
...
representable by `self.dtype`, i.e., `2**(mantissa_bits+1)` (IEEE 754), \- the
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/distributions/categorical.py#L153-L242)
