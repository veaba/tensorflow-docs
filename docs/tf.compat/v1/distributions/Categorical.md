...
```
[logits](https://en.wikipedia.org/wiki/Logit)Creates a 3-class distribution with the 2nd class being most likely. Parameterized by  rather than probabilities.
