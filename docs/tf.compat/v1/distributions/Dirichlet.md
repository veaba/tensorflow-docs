...
[(k-1)-simplex](https://en.wikipedia.org/wiki/Simplex)The Dirichlet distribution is defined over the  using a positive, length-k vector concentration (k > 1). The Dirichlet is identically the Beta distribution when k = 2.
