...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/distributions/dirichlet_multinomial.py#L55-L355)  
---  
...
Dirichlet-Multinomial is a [compound
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/distributions/dirichlet_multinomial.py#L167-L231)
...
self.total_count`. Its shape must be broadcastable with `self.concentration`
