...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/math_ops.py#L1619-L1692)  
---  
...
### Aliases:
  ...
  * [`tf.compat.v1.math.count_nonzero`](/api_docs/python/tf/compat/v1/count_nonzero)
...
`(axis)`. They will be removed in a future version. Instructions for updating:
