...
#### Returns:
- `false_positives`: A f`l``o`a`t` `Tensor` `o`f `s``h`ap`e` [`l``e``n``(``t``h``r``e``s``h``o``l``d``s``)`].
- `update_op`: A`n` `o`p`e``r`a`t`i`o``n` `t``h`a`t` up`d`a`t``e``s` `t``h``e` `false_positives` va`r`iab`l``e` a`n``d` `r``e``t`u`r``n``s` i`t``s` cu`r``r``e``n``t` va`l`u`e`.
#### Raises:
