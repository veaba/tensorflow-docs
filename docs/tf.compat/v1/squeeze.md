...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/array_ops.py#L3597-L3649)  
---  
...
**Warning:** SOME ARGUMENTS ARE DEPRECATED: `(squeeze_dims)`. They will be
