...
<aside class="warning">**Warning:**  SOME ARGUMENTS ARE DEPRECATED:  `(squeeze_dims)` . They will be removed in a future version.
...
time, where  `N`  is the number of elements in the squeezed dimensions.</aside>
