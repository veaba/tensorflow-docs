...
Queue-based input pipelines have been replaced by [ `tf.data` ](https://tensorflow.google.cn/api_docs/python/tf/data). Use [ `tf.data.Dataset.map(tf.read_file)` ](https://tensorflow.google.cn/api_docs/python/tf/data/Dataset#map).</aside>
