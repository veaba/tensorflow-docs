...
This function will only be available through the v1 compatibility library as tf.compat.v1.saved_model.simple_save.</aside>
...
Although in many cases it's not necessary to understand all of the many ways
  ...
  - It will be treated as a graph for inference / serving (i.e. uses the tag
    [ `saved_model.SERVING` ](/api_docs/python/tf/saved_model#SERVING))
  - The SavedModel will load in TensorFlow Serving and supports the
    <a href="https://github.com/tensorflow/serving/blob/master/tensorflow_serving/apis/predict.proto">Predict
    API</a>.
    ...
    or the lower level
    <a href="https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/saved_model/README.md">SavedModel
    APIs</a>.
