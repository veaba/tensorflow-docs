...
```
[tf.reduce_sum()](https://tensorflow.google.cn/api_docs/python/tf/math/reduce_sum)This Op takes a SparseTensor and is the sparse counterpart to . In particular, this Op also returns a dense Tensor instead of a sparse one.
