...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/experimental/ops/batching.py#L83-L136)  
---  
...
version. Instructions for updating: Use `tf.data.experimental.map_and_batch()
