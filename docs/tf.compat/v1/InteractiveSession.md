...
The methods [ `tf.Tensor.eval` ](https://tensorflow.google.cn/api_docs/python/tf/Tensor#eval)
and [ `tf.Operation.run` ](https://tensorflow.google.cn/api_docs/python/tf/Operation#run)
will use that session to run ops.

This is convenient in interactive shells and <a href="http://ipython.org">IPython
notebooks</a>, as it avoids having to pass an explicit
