...
```
[tf.reduce_sum()](https://tensorflow.google.cn/api_docs/python/tf/math/reduce_sum)This Op takes a SparseTensor and is the sparse counterpart to . In contrast to SparseReduceSum, this Op returns a SparseTensor.
