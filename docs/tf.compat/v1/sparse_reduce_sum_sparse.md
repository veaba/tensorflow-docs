...
- [ `tf.compat.v1.sparse.reduce_sum_sparse` ](/api_docs/python/tf/compat/v1/sparse_reduce_sum_sparse)
...
[ `tf.reduce_sum()` ](https://tensorflow.google.cn/api_docs/python/tf/math/reduce_sum).  In contrast to SparseReduceSum, this Op returns a
SparseTensor.
