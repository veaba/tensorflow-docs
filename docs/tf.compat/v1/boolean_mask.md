...
[tf.ragged.boolean_mask](https://www.tensorflow.org/api_docs/python/tf/ragged/boolean_mask)See also: , which can be applied to both dense and ragged tensors, and can be used if you need to preserve the masked dimensions of tensor (rather than flattening them, as tf.boolean_mask does).
