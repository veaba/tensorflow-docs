...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/distribute/mirrored_strategy.py#L361-L368)  
---  
...
This strategy uses one replica per device and sync replication for its multi-
GPU version.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/distribute/mirrored_strategy.py#L365-L368)
