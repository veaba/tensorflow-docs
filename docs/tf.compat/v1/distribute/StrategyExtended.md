...
[StrategyExtended](https://www.tensorflow.org/api_docs/python/tf/distribute/StrategyExtended)Inherits From: 
...
#### Args:
- `v`: A `v`ariable allocated within the scope of this `tf.distribute.Strategy`.
#### Returns:
