...
[`class
CuDNNGRU`](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/layers/CuDNNGRU):
Fast GRU implementation backed by cuDNN.

[`class
CuDNNLSTM`](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/layers/CuDNNLSTM):
