...
[RNN](https://tensorflow.google.cn/api_docs/python/tf/keras/layers/RNN)Inherits From: 

[tf.compat.v1.keras.layers.CuDNNLSTM](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/layers/CuDNNLSTM)Note that this cell is not optimized for performance on GPU. Please use  for better performance on GPU.
