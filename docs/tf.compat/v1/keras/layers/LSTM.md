...
[ `tf.compat.v1.keras.layers.CuDNNLSTM` ](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/layers/CuDNNLSTM) for better performance on GPU.
...
This is recommended in <a href="http://www.jmlr.org/proceedings/papers/v37/jozefowicz15.pdf">Jozefowicz et
al.</a>.
