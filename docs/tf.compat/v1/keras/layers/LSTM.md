...
[tf.compat.v1.keras.layers.CuDNNLSTM](https://www.tensorflow.org/api_docs/python/tf/compat/v1/keras/layers/CuDNNLSTM)Note that this cell is not optimized for performance on GPU. Please use  for better performance on GPU.
