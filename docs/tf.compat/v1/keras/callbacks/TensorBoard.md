...
[details](https://tensorflow.google.cn/how_tos/embedding_viz/#metadata_optional)
  about metadata files format. In case if the same metadata file is
  used for all embedding layers, string can be passed.

- **`embeddings_data`** : data to be embedded at layers specified in
 `embeddings_layer_names` . Numpy array (if the model has a single input)
or list of Numpy arrays (if the model has multiple inputs). Learn <a href="https://tensorflow.google.cn/programmers_guide/embedding">more
about
  embeddings</a>
