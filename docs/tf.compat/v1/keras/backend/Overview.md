...
[ `get_session(...)` ](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/backend/get_session): Returns the TF session to be used by the backend.
...
[ `set_session(...)` ](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/backend/set_session): Sets the global TensorFlow session.
