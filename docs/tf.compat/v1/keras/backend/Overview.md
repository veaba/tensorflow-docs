...
[`get_session(...)`](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/backend/get_session):
...
[`set_session(...)`](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/backend/set_session):
