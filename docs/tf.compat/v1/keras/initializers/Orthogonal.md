...
**Aliases** : [ `tf.compat.v1.initializers.orthogonal` ](/api_docs/python/tf/compat/v1/keras/initializers/Orthogonal), [ `tf.compat.v1.keras.initializers.orthogonal` ](/api_docs/python/tf/compat/v1/keras/initializers/Orthogonal), [ `tf.compat.v1.orthogonal_initializer` ](/api_docs/python/tf/compat/v1/keras/initializers/Orthogonal)
