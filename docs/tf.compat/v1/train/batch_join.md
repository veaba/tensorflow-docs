...
```
[tf.compat.v1.train.batch()](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/train/batch)The tensors_list argument is a list of tuples of tensors, or a list of dictionaries of tensors. Each element in the list is treated similarly to the tensors argument of .
