...
## Modules
[experimental](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/train/experimental) module: Public API for tf.train. namespace.

[queue_runner](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/train/queue_runner) module: Public API for tf.train. namespace.
...
[init_from_checkpoint(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/train/init_from_checkpoint): Replaces tf.Variable initializers so they load from a checkpoint file.
