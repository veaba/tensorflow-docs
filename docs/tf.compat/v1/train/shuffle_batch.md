...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/input.py#L1247-L1347)  
---  
...
_N.B.:_ You must ensure that either (i) the `shapes` argument is passed, or
