...
<em>checkpoints</em>.  It also provides convenience methods to run these ops.
...
<aside class="note">**Note:**  the newer  `AutoTrackable`  API is not supported by  `Saver` . In this
case, the [ `tf.train.Checkpoint` ](https://tensorflow.google.cn/api_docs/python/tf/train/Checkpoint) class should be used.</aside>
...
fragile. Please switch to [ `tf.train.Checkpoint` ](https://tensorflow.google.cn/api_docs/python/tf/train/Checkpoint) or
[ `tf.keras.Model.save_weights` ](https://tensorflow.google.cn/api_docs/python/tf/keras/Model#save_weights), which perform a more robust object-based
...
<a href="https://github.com/tensorflow/tensorflow/blob/master/tensorflow/python/saved_model/README.md#stripping-default-valued-attributes">Stripping Default-Valued
Attributes</a>.
