...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/learning_rate_decay.py#L514-L585)  
---  
...
possible warm restarts. The learning rate multiplier first decays from 1 to
