...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/training/learning_rate_decay.py#L106-L179)  
---  
...
### Aliases:
  ...
  * [`tf.compat.v1.train.piecewise_constant_decay`](/api_docs/python/tf/compat/v1/train/piecewise_constant)
