...
[tf.compat.v1.train.MonitoredTrainingSession](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/train/MonitoredTrainingSession)This class is deprecated. Please use  instead.
...
[tf.errors.OutOfRangeError](https://tensorflow.google.cn/api_docs/python/tf/errors/OutOfRangeError)Exceptions that indicate that the training inputs have been exhausted, , also cause sv.should_stop() to return True but are not re-raised from the with block: they indicate a normal termination.
...
[Coordinator.request_stop()](https://tensorflow.google.cn/api_docs/python/tf/train/Coordinator#request_stop)See .
...
[Coordinator.should_stop()](https://tensorflow.google.cn/api_docs/python/tf/train/Coordinator#should_stop)See .
...
- RuntimeError: If called with eager execution enabled.
#### Eager Compatibility
[tf.data](https://tensorflow.google.cn/api_docs/python/tf/data)Queues are not compatible with eager execution. To ingest data when eager execution is enabled, use the  API.
...
[Coordinator.stop_on_exception()](https://tensorflow.google.cn/api_docs/python/tf/train/Coordinator#stop_on_exception)See .
