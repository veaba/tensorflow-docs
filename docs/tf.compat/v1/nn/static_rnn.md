...
Please use [ `keras.layers.RNN(cell, unroll=True)` ](/api_docs/python/tf/keras/layers/RNN), which is equivalent to this API</aside>
...
input_size]</code>, or a nested tuple of such elements.
