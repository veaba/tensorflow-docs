...
<devsite-code><pre class="prettyprint lang-python" translate="no" dir="ltr" is-upgraded=""><code translate="no" dir="ltr">tf.compat.v1.nn.convolution(
    input,
    filter,
    padding,
    strides=None,
...
an optional  `dilation_rate`  tensor of shape [N](/api_docs/python/tf/compat/v1/nn/defaulting%20to%20%5B1%5D*N)
...
size used for the convolution will be <code translate="no" dir="ltr">spatial_filter_shape +
