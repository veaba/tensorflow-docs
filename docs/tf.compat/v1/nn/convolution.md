...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/nn_ops.py#L764-L898)  
---  
...
an optional `dilation_rate` tensor of shape
[N](/api_docs/python/tf/compat/v1/nn/defaulting%20to%20%5B1%5D*N) specifying
the filter upsampling/input downsampling rate, and an optional list of N
`strides` (defaulting [1]*N), this computes for each N-D spatial output
position (x[0], ..., x[N-1]):
