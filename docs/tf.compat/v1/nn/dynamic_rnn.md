...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/rnn.py#L517-L716)  
---  
...
[`keras.layers.RNN(cell)`](/api_docs/python/tf/keras/layers/RNN), which is
