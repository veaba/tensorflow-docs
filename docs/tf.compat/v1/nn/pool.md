   ...
   output[b, x[0], ..., x[N-1], c] =
    REDUCE_{z[0], ..., z[N-1]}
      input[b,
            ...
            c],
```
[tf.nn.convolution](https://tensorflow.google.cn/api_docs/python/tf/nn/convolution)where the reduction function REDUCE depends on the value of pooling_type, and pad_before is defined based on the value of padding as described in the "returns" section of  for details. The reduction never includes out-of-bounds positions.
