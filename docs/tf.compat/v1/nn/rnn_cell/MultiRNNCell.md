...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/rnn_cell_impl.py#L1198-L1319)  
---  
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/rnn_cell_impl.py#L1210-L1249)
...
tf.keras.layers.StackedRNNCells, and will be replaced by that in Tensorflow
2.0.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/rnn_cell_impl.py#L1262-L1269)
