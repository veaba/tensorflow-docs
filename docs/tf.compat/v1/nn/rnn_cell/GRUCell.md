...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/rnn_cell_impl.py#L484-L609)  
---  
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/rnn_cell_impl.py#L510-L539)
...
tf.keras.layers.GRUCell, and will be replaced by that in Tensorflow 2.0.
