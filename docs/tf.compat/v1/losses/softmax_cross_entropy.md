...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/losses/losses_impl.py#L713-L781)  
---  
...
new_onehot_labels = onehot_labels * (1 - label_smoothing) \+ label_smoothing /
num_classes
