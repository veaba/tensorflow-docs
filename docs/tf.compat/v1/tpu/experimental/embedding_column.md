[tf.compat.v1.feature_column.embedding_column](https://tensorflow.google.cn/api_docs/python/tf/feature_column/embedding_column)TPU version of .
...
[tf.compat.v1.feature_column.embedding_column](https://tensorflow.google.cn/api_docs/python/tf/feature_column/embedding_column)Use this function in place of  when you want to use the TPU to accelerate your embedding lookups via TPU embeddings.
