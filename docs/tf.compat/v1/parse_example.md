...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/parsing_ops.py#L367-L581)  
---  
...
[`SparseFeature.index_key[j]`](/api_docs/python/tf/io/SparseFeature#index_key).
