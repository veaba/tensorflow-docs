...
argv[0](/api_docs/python/tf/compat/v1/flags/e.g.%20the%20program%20name) are returned.
...
a **call** () invocation has happened.  This is only a public method for
...
place where the --flagfile arg is found.</somefile></somefile>
...
--> Entirely blank lines <em>should</em> be ignored.</otherfile.cfg>
...
library.  Please maintain this consistency.</key>
