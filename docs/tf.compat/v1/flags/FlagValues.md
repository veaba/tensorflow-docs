...
### Aliases:
  ...
  * Class [`tf.compat.v1.app.flags.FlagValues`](/api_docs/python/tf/compat/v1/flags/FlagValues)
...
'Flag' objects are registered via **setitem** : FLAGS['longname'] = x #
register a new flag
...
through the **call** method. Unparsed arguments, including
argv[0](/api_docs/python/tf/compat/v1/flags/e.g.%20the%20program%20name) are
returned. argv = FLAGS(sys.argv) # scan command line arguments
...
**call** () invocation has happened. This is only a public method for use by
things like appcommands which do additional command like parsing.
...
flagfile, a line beginning with # or // is a comment. \--> Entirely blank
lines _should_ be ignored.
