...
[0](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/flags/e.g.%20the%20program%20name)Command line arguments are scanned and passed to the registered 'Flag' objects through the call method. Unparsed arguments, including argv are returned. argv = FLAGS(sys.argv) # scan command line arguments
