...
This regressor ignores feature values and will learn to predict the averagevalue of each label.
...
If the string filepath is provided instead of a [ `tf.estimator.WarmStartSettings` ](../../../../tf/estimator/WarmStartSettings), then all variables arewarm-started, and it is assumed that vocabularies and [ `tf.Tensor` ](../../../../tf/Tensor) names are unchanged.
