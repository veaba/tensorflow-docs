...
```
[tf.math.add](https://www.tensorflow.org/api_docs/python/tf/math/add)This operation outputs "ref" after the update is done. This makes it easier to chain operations that need to use the reset value. Unlike , this op does not broadcast. ref and value must have the same shape.
