...
[DeviceSpec](https://tensorflow.google.cn/api_docs/python/tf/DeviceSpec)Inherits From: 
...
[DeviceSpec.from_string](https://tensorflow.google.cn/api_docs/python/tf/DeviceSpec#from_string)In general,  should completely replace DeviceSpec.parse_from_string, and DeviceSpec.replace should completely replace setting attributes directly.
