...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/math_ops.py#L187-L200)  
---  
...
### Aliases:
  ...
  * [`tf.compat.v1.math.argmin`](/api_docs/python/tf/compat/v1/argmin)
...
**Warning:** SOME ARGUMENTS ARE DEPRECATED: `(dimension)`. They will be
removed in a future version. Instructions for updating: Use the `axis`
argument instead
