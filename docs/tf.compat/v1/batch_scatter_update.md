[tf.compat.v1.scatter_update](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/scatter_update)Generalization of  to axis different than 0. (deprecated)
