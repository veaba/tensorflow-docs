[tf.compat.v1.scatter_update](https://www.tensorflow.org/api_docs/python/tf/compat/v1/scatter_update)Generalization of  to axis different than 0. (deprecated)
