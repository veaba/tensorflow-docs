...
[audio](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/audio) module: Public API for tf. namespace.
...
[compat](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/compat) module: Functions for Python 2 vs. 3 ibility.

[config](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/config) module: Public API for tf. namespace.

[data](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/data) module: tf..Dataset API for input pipelines.

[debugging](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/debugging) module: Public API for tf. namespace.
...
[dtypes](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/dtypes) module: Public API for tf. namespace.

[errors](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/errors) module: Exception types for TensorFlow .
...
[experimental](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/experimental) module: Public API for tf. namespace.

[feature_column](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/feature_column) module: Public API for tf. namespace.
...
[initializers](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/initializers) module: Public API for tf. namespace.

[io](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/io) module: Public API for tf. namespace.
...
[layers](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/layers) module: Public API for tf. namespace.

[linalg](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/linalg) module: Operations for linear algebra.

[lite](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/lite) module: Public API for tf. namespace.

[logging](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/logging) module: Logging and Summary Operations.

[lookup](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/lookup) module: Public API for tf. namespace.

[losses](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/losses) module: Loss operations for use in neural networks.

[manip](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/manip) module: Operators for ulating tensors.

[math](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/math) module: Math Operations.

[metrics](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/metrics) module: Evaluation-related .

[nest](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/nest) module: Public API for tf. namespace.

[nn](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/nn) module: Wrappers for primitive Neural Net (NN) Operations.

[profiler](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/profiler) module: Public API for tf. namespace.
...
[quantization](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/quantization) module: Public API for tf. namespace.

[queue](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/queue) module: Public API for tf. namespace.

[ragged](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/ragged) module: Ragged Tensors.

[random](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/random) module: Public API for tf. namespace.

[raw_ops](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/raw_ops) module: Public API for tf. namespace.
...
[saved_model](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/saved_model) module: Public API for tf. namespace.
...
[spectral](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/spectral) module: Public API for tf. namespace.
...
[summary](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/summary) module: Operations for writing  data, for use in analysis and visualization.
...
[train](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/train) module: Support for ing models.

[user_ops](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/user_ops) module: Public API for tf. namespace.

[version](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/version) module: Public API for tf. namespace.

[xla](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/xla) module: Public API for tf. namespace.
...
[class Variable](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/Variable): See the Variables Guide.
...
[add_check_numerics_ops(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/add_check_numerics_ops): Connect a tf.debugging.check_numerics to every floating point tensor.

[add_n(...)](https://tensorflow.google.cn/api_docs/python/tf/math/add_n): Adds all input tensors element-wise.

[add_to_collection(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/add_to_collection): Wrapper for Graph.add_to_collection() using the default graph.

[add_to_collections(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/add_to_collections): Wrapper for Graph.add_to_collections() using the default graph.

[all_variables(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/all_variables): Use tf.compat.v1.global_variables instead. (deprecated)
...
[batch_scatter_update(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/batch_scatter_update): Generalization of tf.compat.v1.scatter_update to axis different than 0. (deprecated)
...
[container(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/container): Wrapper for Graph.container() using the default graph.
...
[device(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/device): Wrapper for Graph.device() using the default graph.
...
[get_collection(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/get_collection): Wrapper for Graph.get_collection() using the default graph.

[get_collection_ref(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/get_collection_ref): Wrapper for Graph.get_collection_ref() using the default graph.
...
[initialize_all_variables(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/initialize_all_variables): See tf.compat.v1.global_variables_initializer. (deprecated)

[initialize_local_variables(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/initialize_local_variables): See tf.compat.v1.local_variables_initializer. (deprecated)

[initialize_variables(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/initialize_variables): See tf.compat.v1.variables_initializer. (deprecated)
...
[lbeta(...)](https://tensorflow.google.cn/api_docs/python/tf/math/lbeta): Computes
...
[quantize_v2(...)](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/quantize_v2): Please use tf.quantization.quantize instead.
