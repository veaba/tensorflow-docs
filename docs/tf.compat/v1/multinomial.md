...
- [ `tf.compat.v1.random.multinomial` ](/api_docs/python/tf/compat/v1/multinomial)
...
Use [ `tf.random.categorical` ](https://tensorflow.google.cn/api_docs/python/tf/random/categorical) instead.</aside>
