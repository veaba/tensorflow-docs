...
[bincount(...)](https://www.tensorflow.org/api_docs/python/tf/math/bincount): Counts the number of occurrences of each value in an integer array.

[ceil(...)](https://www.tensorflow.org/api_docs/python/tf/math/ceil): Returns element-wise smallest integer not less than x.

[confusion_matrix(...)](https://www.tensorflow.org/api_docs/python/tf/math/confusion_matrix): Computes the confusion matrix from predictions and labels.
...
[count_nonzero(...)](https://www.tensorflow.org/api_docs/python/tf/math/count_nonzero): Computes number of nonzero elements across dimensions of a tensor.
