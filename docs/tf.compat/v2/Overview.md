...
## Modules
[audio](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/audio) module: Public API for tf. namespace.
...
[bitwise](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/bitwise) module: Operations for manipulating the binary representations of integers.

[compat](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/compat) module: Functions for Python 2 vs. 3 ibility.

[config](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/config) module: Public API for tf. namespace.

[data](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/data) module: tf..Dataset API for input pipelines.

[debugging](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/debugging) module: Public API for tf. namespace.

[distribute](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/distribute) module: Library for running a computation across multiple devices.

[dtypes](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/dtypes) module: Public API for tf. namespace.

[errors](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/errors) module: Exception types for TensorFlow .

[estimator](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/estimator) module: Estimator: High level tools for working with models.

[experimental](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/experimental) module: Public API for tf. namespace.

[feature_column](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/feature_column) module: Public API for tf. namespace.

[graph_util](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/graph_util) module: Helpers to manipulate a tensor graph in python.

[image](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/image) module: Image processing and decoding ops.
...
[io](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/io) module: Public API for tf. namespace.

[keras](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/keras) module: Implementation of the Keras API meant to be a high-level API for TensorFlow.

[linalg](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/linalg) module: Operations for linear algebra.

[lite](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/lite) module: Public API for tf. namespace.

[lookup](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/lookup) module: Public API for tf. namespace.

[losses](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/keras/losses) module: Built-in loss functions.

[math](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/math) module: Math Operations.

[metrics](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/keras/metrics) module: Built-in .

[nest](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/nest) module: Public API for tf. namespace.

[nn](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/nn) module: Wrappers for primitive Neural Net (NN) Operations.

[optimizers](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/keras/optimizers) module: Built-in optimizer classes.

[quantization](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/quantization) module: Public API for tf. namespace.

[queue](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/queue) module: Public API for tf. namespace.

[ragged](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/ragged) module: Ragged Tensors.

[random](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/random) module: Public API for tf. namespace.

[raw_ops](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/raw_ops) module: Public API for tf. namespace.

[saved_model](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/saved_model) module: Public API for tf. namespace.

[sets](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/sets) module: Tensorflow set operations.

[signal](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/signal) module: Signal processing operations.

[sparse](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/sparse) module: Sparse Tensor Representation.

[strings](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/strings) module: Operations for working with string Tensors.
...
[sysconfig](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/sysconfig) module: System configuration library.

[test](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/test) module: Testing.

[tpu](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/tpu) module: Ops related to Tensor Processing Units.

[train](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/train) module: Support for ing models.

[version](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/version) module: Public API for tf. namespace.

[xla](https://tensorflow.google.cn/api_docs/python/tf/compat/v2/xla) module: Public API for tf. namespace.
