...
version](/versions/r1.15/api_docs/python/tf/keras/layers/LocallyConnected1D) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/local.py#L36-L331)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.layers.LocallyConnected1D`](/api_docs/python/tf/keras/layers/LocallyConnected1D)
  * Class [`tf.compat.v2.keras.layers.LocallyConnected1D`](/api_docs/python/tf/keras/layers/LocallyConnected1D)
...
`input_filters`, large `input_size`, `output_size`), and "sparse" stands for
few connections between inputs and outputs, i.e. small ratio `filters *
input_filters * kernel_size / (input_size * strides)`, where inputs to and
outputs of the layer are assumed to have shapes `(input_size, input_filters)`,
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/local.py#L131-L168)
