...
**Aliases** : [ `tf.compat.v1.keras.layers.GaussianDropout` ](/api_docs/python/tf/keras/layers/GaussianDropout), [ `tf.compat.v2.keras.layers.GaussianDropout` ](/api_docs/python/tf/keras/layers/GaussianDropout)
