...
**别名** : [ `tf.compat.v1.keras.layers.MaxPool2D` ](/api_docs/python/tf/keras/layers/MaxPool2D), [ `tf.compat.v1.keras.layers.MaxPooling2D` ](/api_docs/python/tf/keras/layers/MaxPool2D), [ `tf.compat.v2.keras.layers.MaxPool2D` ](/api_docs/python/tf/keras/layers/MaxPool2D), [ `tf.compat.v2.keras.layers.MaxPooling2D` ](/api_docs/python/tf/keras/layers/MaxPool2D), [ `tf.keras.layers.MaxPooling2D` ](/api_docs/python/tf/keras/layers/MaxPool2D)
