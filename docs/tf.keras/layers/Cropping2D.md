...
**Aliases** : [ `tf.compat.v1.keras.layers.Cropping2D` ](/api_docs/python/tf/keras/layers/Cropping2D), [ `tf.compat.v2.keras.layers.Cropping2D` ](/api_docs/python/tf/keras/layers/Cropping2D)
