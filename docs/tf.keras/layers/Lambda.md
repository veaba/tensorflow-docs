...
**Aliases** : [ `tf.compat.v1.keras.layers.Lambda` ](/api_docs/python/tf/keras/layers/Lambda), [ `tf.compat.v2.keras.layers.Lambda` ](/api_docs/python/tf/keras/layers/Lambda)
