...
version](/versions/r1.15/api_docs/python/tf/keras/layers/GRU) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/recurrent_v2.py#L147-L406)  
---|---  
...
Inherits From:
[`GRU`](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/keras/layers/GRU)

### Aliases:

  * Class [`tf.compat.v2.keras.layers.GRU`](/api_docs/python/tf/keras/layers/GRU)
...
on CPU. Thus it has separate biases for `kernel` and `recurrent_kernel`. To
use this variant, set `'reset_after'=True` and
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/recurrent_v2.py#L249-L309)
