...
**Aliases** : [ `tf.compat.v1.keras.layers.UpSampling2D` ](/api_docs/python/tf/keras/layers/UpSampling2D), [ `tf.compat.v2.keras.layers.UpSampling2D` ](/api_docs/python/tf/keras/layers/UpSampling2D)
