...
**别名** : [ `tf.compat.v1.keras.layers.ZeroPadding2D` ](/api_docs/python/tf/keras/layers/ZeroPadding2D), [ `tf.compat.v2.keras.layers.ZeroPadding2D` ](/api_docs/python/tf/keras/layers/ZeroPadding2D)
