...
version](/versions/r1.15/api_docs/python/tf/keras/layers/UpSampling3D) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/convolutional.py#L2000-L2069)  
...
5D tensor with shape: \- If `data_format` is `"channels_last"`: `(batch, dim1,
dim2, dim3, channels)` \- If `data_format` is `"channels_first"`: `(batch,
channels, dim1, dim2, dim3)`

#### Output shape:

5D tensor with shape: \- If `data_format` is `"channels_last"`: `(batch,
upsampled_dim1, upsampled_dim2, upsampled_dim3, channels)` \- If `data_format`
is `"channels_first"`: `(batch, channels, upsampled_dim1, upsampled_dim2,
upsampled_dim3)`

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/convolutional.py#L2035-L2039)
