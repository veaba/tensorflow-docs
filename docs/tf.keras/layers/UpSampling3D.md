...
**Aliases** : [ `tf.compat.v1.keras.layers.UpSampling3D` ](/api_docs/python/tf/keras/layers/UpSampling3D), [ `tf.compat.v2.keras.layers.UpSampling3D` ](/api_docs/python/tf/keras/layers/UpSampling3D)
