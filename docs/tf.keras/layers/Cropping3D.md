...
**别名** : [ `tf.compat.v1.keras.layers.Cropping3D` ](/api_docs/python/tf/keras/layers/Cropping3D), [ `tf.compat.v2.keras.layers.Cropping3D` ](/api_docs/python/tf/keras/layers/Cropping3D)
