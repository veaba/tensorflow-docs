...
**Aliases** : [ `tf.compat.v1.keras.layers.DepthwiseConv2D` ](/api_docs/python/tf/keras/layers/DepthwiseConv2D), [ `tf.compat.v2.keras.layers.DepthwiseConv2D` ](/api_docs/python/tf/keras/layers/DepthwiseConv2D)
