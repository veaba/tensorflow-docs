...
**Aliases** : [ `tf.compat.v1.keras.layers.GaussianNoise` ](/api_docs/python/tf/keras/layers/GaussianNoise), [ `tf.compat.v2.keras.layers.GaussianNoise` ](/api_docs/python/tf/keras/layers/GaussianNoise)
