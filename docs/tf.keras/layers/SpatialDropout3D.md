...
**Aliases** : [ `tf.compat.v1.keras.layers.SpatialDropout3D` ](/api_docs/python/tf/keras/layers/SpatialDropout3D), [ `tf.compat.v2.keras.layers.SpatialDropout3D` ](/api_docs/python/tf/keras/layers/SpatialDropout3D)
