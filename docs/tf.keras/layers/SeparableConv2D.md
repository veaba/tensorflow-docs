...
version](/versions/r1.15/api_docs/python/tf/keras/layers/SeparableConv2D) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/convolutional.py#L1535-L1682)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.layers.SeparableConv2D`](/api_docs/python/tf/keras/layers/SeparableConv2D)
  * Class [`tf.compat.v1.keras.layers.SeparableConvolution2D`](/api_docs/python/tf/keras/layers/SeparableConv2D)
  * Class [`tf.compat.v2.keras.layers.SeparableConv2D`](/api_docs/python/tf/keras/layers/SeparableConv2D)
  * Class [`tf.compat.v2.keras.layers.SeparableConvolution2D`](/api_docs/python/tf/keras/layers/SeparableConv2D)
  * Class [`tf.keras.layers.SeparableConvolution2D`](/api_docs/python/tf/keras/layers/SeparableConv2D)
...
per input channel in the depthwise step.

Intuitively, separable convolutions can be understood as a way to factorize a
convolution kernel into two smaller kernels, or as an extreme version of an
Inception block.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/convolutional.py#L1615-L1657)
