## Class Layer
Base layer class.
[Module](https://tensorflow.google.cn/api_docs/python/tf/Module)Inherits From: 
...
[tf.GradientTape](https://tensorflow.google.cn/api_docs/python/tf/GradientTape)Variable regularization tensors are created when this property is accessed, so it is eager safe: accessing losses under a  will propagate gradients back to the corresponding variables.
