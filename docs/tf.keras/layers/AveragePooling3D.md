...
**别名** : [ `tf.compat.v1.keras.layers.AveragePooling3D` ](/api_docs/python/tf/keras/layers/AveragePooling3D), [ `tf.compat.v1.keras.layers.AvgPool3D` ](/api_docs/python/tf/keras/layers/AveragePooling3D), [ `tf.compat.v2.keras.layers.AveragePooling3D` ](/api_docs/python/tf/keras/layers/AveragePooling3D), [ `tf.compat.v2.keras.layers.AvgPool3D` ](/api_docs/python/tf/keras/layers/AveragePooling3D), [ `tf.keras.layers.AvgPool3D` ](/api_docs/python/tf/keras/layers/AveragePooling3D)
