...
**Aliases** : [ `tf.compat.v1.keras.layers.AlphaDropout` ](/api_docs/python/tf/keras/layers/AlphaDropout), [ `tf.compat.v2.keras.layers.AlphaDropout` ](/api_docs/python/tf/keras/layers/AlphaDropout)
