...
**Aliases** : [ `tf.compat.v1.keras.layers.LeakyReLU` ](/api_docs/python/tf/keras/layers/LeakyReLU), [ `tf.compat.v2.keras.layers.LeakyReLU` ](/api_docs/python/tf/keras/layers/LeakyReLU)
