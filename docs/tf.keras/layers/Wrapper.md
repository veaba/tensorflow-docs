...
**Aliases** : [ `tf.compat.v1.keras.layers.Wrapper` ](/api_docs/python/tf/keras/layers/Wrapper), [ `tf.compat.v2.keras.layers.Wrapper` ](/api_docs/python/tf/keras/layers/Wrapper)
