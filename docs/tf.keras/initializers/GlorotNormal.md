...
**Aliases** : [ `tf.compat.v2.initializers.GlorotNormal` ](/api_docs/python/tf/keras/initializers/GlorotNormal), [ `tf.compat.v2.initializers.glorot_normal` ](/api_docs/python/tf/keras/initializers/GlorotNormal), [ `tf.compat.v2.keras.initializers.GlorotNormal` ](/api_docs/python/tf/keras/initializers/GlorotNormal), [ `tf.compat.v2.keras.initializers.glorot_normal` ](/api_docs/python/tf/keras/initializers/GlorotNormal), [ `tf.initializers.GlorotNormal` ](/api_docs/python/tf/keras/initializers/GlorotNormal), [ `tf.initializers.glorot_normal` ](/api_docs/python/tf/keras/initializers/GlorotNormal), [ `tf.keras.initializers.glorot_normal` ](/api_docs/python/tf/keras/initializers/GlorotNormal)
