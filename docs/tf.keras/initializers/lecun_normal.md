...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/init_ops_v2.py#L631-L654)  
---  
...
`stddev = sqrt(1 / fan_in)` where `fan_in` is the number of input units in the
weight tensor.
