...
**Aliases** : [ `tf.compat.v2.initializers.he_uniform` ](/api_docs/python/tf/keras/initializers/he_uniform), [ `tf.compat.v2.keras.initializers.he_uniform` ](/api_docs/python/tf/keras/initializers/he_uniform), [ `tf.initializers.he_uniform` ](/api_docs/python/tf/keras/initializers/he_uniform)
