...
**Aliases** : [ `tf.compat.v2.initializers.he_normal` ](/api_docs/python/tf/keras/initializers/he_normal), [ `tf.compat.v2.keras.initializers.he_normal` ](/api_docs/python/tf/keras/initializers/he_normal), [ `tf.initializers.he_normal` ](/api_docs/python/tf/keras/initializers/he_normal)
