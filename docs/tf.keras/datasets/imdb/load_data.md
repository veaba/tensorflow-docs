...
**Aliases** : [ `tf.compat.v1.keras.datasets.imdb.load_data` ](/api_docs/python/tf/keras/datasets/imdb/load_data), [ `tf.compat.v2.keras.datasets.imdb.load_data` ](/api_docs/python/tf/keras/datasets/imdb/load_data)
