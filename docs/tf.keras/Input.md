...
**Aliases** : [ `tf.compat.v1.keras.Input` ](/api_docs/python/tf/keras/Input), [ `tf.compat.v1.keras.layers.Input` ](/api_docs/python/tf/keras/Input), [ `tf.compat.v2.keras.Input` ](/api_docs/python/tf/keras/Input), [ `tf.compat.v2.keras.layers.Input` ](/api_docs/python/tf/keras/Input), [ `tf.keras.layers.Input` ](/api_docs/python/tf/keras/Input)
