...
**Aliases** : [ `tf.compat.v1.keras.experimental.WideDeepModel` ](/api_docs/python/tf/keras/experimental/WideDeepModel), [ `tf.compat.v2.keras.experimental.WideDeepModel` ](/api_docs/python/tf/keras/experimental/WideDeepModel)
