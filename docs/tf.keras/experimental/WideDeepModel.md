...
- ``A`` ``N``u``m``p``y`` ``a``r``r``a``y`` ``(``o``r`` ``a``r``r``a``y``-``l``i``k``e``)``,`` ``o``r`` ``a`` ``l``i``s``t`` ``o``f`` ``a``r``r``a``y``s`` ``(``i``n`` ``c``a``s``e`` ``t``h``e`` ``m``o``d``e``l`` ``h``a``s`` ``m``u``l``t``i``p``l``e`` ``i``n``p``u``t``s``)``.``
- ``A`` ``T``e``n``s``o``r``F``l``o``w`` ``t``e``n``s``o``r``,`` ``o``r`` ``a`` ``l``i``s``t`` ``o``f`` ``t``e``n``s``o``r``s`` ``(``i``n`` ``c``a``s``e`` ``t``h``e`` ``m``o``d``e``l`` ``h``a``s`` ``m``u``l``t``i``p``l``e`` ``i``n``p``u``t``s``)``.``
- ``A`` ``d``i``c``t`` ``m``a``p``p``i``n``g`` ``i``n``p``u``t`` ``n``a``m``e``s`` ``t``o`` ``t``h``e`` ``c``o``r``r``e``s``p``o``n``d``i``n``g`` ``a``r``r``a``y``/``t``e``n``s``o``r``s``,`` ``i``f`` ``t``h``e`` ``m``o``d``e``l`` ``h``a``s`` ``n``a``m``e``d`` ``i``n``p``u``t``s``.``
- A `tf.data` dataset.
- A generator or `keras.utils.Sequence` instance.
...
- `steps`: Total number of `steps` (batches of samples) before declaring the `predict`ion round finished. Ignored with the default value of `None`. If x is a `tf.data` dataset and `steps` is `None`, `predict` will run until the input dataset is exhausted.
