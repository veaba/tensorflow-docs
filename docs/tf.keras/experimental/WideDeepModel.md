...
version](/versions/r1.15/api_docs/python/tf/keras/experimental/WideDeepModel)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/premade/wide_deep.py#L31-L193)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.experimental.WideDeepModel`](/api_docs/python/tf/keras/experimental/WideDeepModel)
  * Class [`tf.compat.v2.keras.experimental.WideDeepModel`](/api_docs/python/tf/keras/experimental/WideDeepModel)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/premade/wide_deep.py#L71-L87)
...
#### Args:
  ...
  * **`dnn_model`** : a [`tf.keras.Model`](https://tensorflow.google.cn/api_docs/python/tf/keras/Model), its output must match the output of the linear model.
