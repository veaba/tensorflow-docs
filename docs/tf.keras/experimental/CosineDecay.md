...
**Aliases** : [ `tf.compat.v1.keras.experimental.CosineDecay` ](/api_docs/python/tf/keras/experimental/CosineDecay), [ `tf.compat.v2.keras.experimental.CosineDecay` ](/api_docs/python/tf/keras/experimental/CosineDecay)
