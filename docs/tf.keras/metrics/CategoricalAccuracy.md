...
[tf.one_hot](https://www.tensorflow.org/api_docs/python/tf/one_hot)y_pred and y_true should be passed in as vectors of probabilities, rather than as labels. If necessary, use  to expand y_true as a vector.
