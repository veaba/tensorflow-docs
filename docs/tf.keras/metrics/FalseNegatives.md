...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/FalseNegatives) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L954-L1000)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.metrics.FalseNegatives`](/api_docs/python/tf/keras/metrics/FalseNegatives)
  * Class [`tf.compat.v2.keras.metrics.FalseNegatives`](/api_docs/python/tf/keras/metrics/FalseNegatives)
  * Class [`tf.compat.v2.metrics.FalseNegatives`](/api_docs/python/tf/keras/metrics/FalseNegatives)
  * Class [`tf.metrics.FalseNegatives`](/api_docs/python/tf/keras/metrics/FalseNegatives)

### Used in the tutorials:

  * [Classification on imbalanced data](https://tensorflow.google.cn/tutorials/structured_data/imbalanced_data)

For example, if `y_true` is [0, 1, 1, 1] and `y_pred` is [0, 1, 0, 0] then the
false negatives value is 2. If the weights were specified as [0, 0, 1, 0] then
the false negatives value would be 1.
...
to keep track of the number of false negatives.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L984-L1000)
