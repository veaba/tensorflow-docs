...
**Aliases** : [ `tf.compat.v1.keras.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives), [ `tf.compat.v2.keras.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives), [ `tf.compat.v2.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives), [ `tf.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives)
...
If  `sample_weight`  is given, calculates the sum of the weights oftrue negatives. This metric creates one local variable,  `accumulator` that is used to keep track of the number of true negatives.
