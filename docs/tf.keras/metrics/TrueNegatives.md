...
**别名** : [ `tf.compat.v1.keras.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives), [ `tf.compat.v2.keras.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives), [ `tf.compat.v2.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives), [ `tf.metrics.TrueNegatives` ](/api_docs/python/tf/keras/metrics/TrueNegatives)
