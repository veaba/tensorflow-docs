...
**Aliases** : [ `tf.compat.v1.keras.metrics.Hinge` ](/api_docs/python/tf/keras/metrics/Hinge), [ `tf.compat.v2.keras.metrics.Hinge` ](/api_docs/python/tf/keras/metrics/Hinge), [ `tf.compat.v2.metrics.Hinge` ](/api_docs/python/tf/keras/metrics/Hinge), [ `tf.metrics.Hinge` ](/api_docs/python/tf/keras/metrics/Hinge)
