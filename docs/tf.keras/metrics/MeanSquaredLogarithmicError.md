...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/MeanSquaredLogarithmicError)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L2005-L2029)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.metrics.MeanSquaredLogarithmicError`](/api_docs/python/tf/keras/metrics/MeanSquaredLogarithmicError)
  * Class [`tf.compat.v2.keras.metrics.MeanSquaredLogarithmicError`](/api_docs/python/tf/keras/metrics/MeanSquaredLogarithmicError)
  * Class [`tf.compat.v2.metrics.MeanSquaredLogarithmicError`](/api_docs/python/tf/keras/metrics/MeanSquaredLogarithmicError)
  * Class [`tf.metrics.MeanSquaredLogarithmicError`](/api_docs/python/tf/keras/metrics/MeanSquaredLogarithmicError)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L2027-L2029)
