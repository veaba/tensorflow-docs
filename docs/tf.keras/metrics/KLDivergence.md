...
**别名** : [ `tf.compat.v1.keras.metrics.KLDivergence` ](/api_docs/python/tf/keras/metrics/KLDivergence), [ `tf.compat.v2.keras.metrics.KLDivergence` ](/api_docs/python/tf/keras/metrics/KLDivergence), [ `tf.compat.v2.metrics.KLDivergence` ](/api_docs/python/tf/keras/metrics/KLDivergence), [ `tf.metrics.KLDivergence` ](/api_docs/python/tf/keras/metrics/KLDivergence)
