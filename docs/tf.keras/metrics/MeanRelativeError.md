...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/MeanRelativeError) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L458-L538)  
---|---  
...
`sample_weight`, and it is ultimately returned as `mean_relative_error`: an
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L492-L502)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L504-L532)
