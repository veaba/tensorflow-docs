...
<table class="tfo-notebook-buttons tfo-api" align="left"><tbody><tr><td>
  <a target="_blank" href="/versions/r1.15/api_docs/python/tf/keras/metrics/Recall">
  ![](https://tensorflow.google.cn/images/tf_logo_32px.png)
  TensorFlow 1 version</a>
</td><td>
  <a target="_blank" href="https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L1231-L1353">
