...
**Aliases** : [ `tf.compat.v1.keras.metrics.LogCoshError` ](/api_docs/python/tf/keras/metrics/LogCoshError), [ `tf.compat.v2.keras.metrics.LogCoshError` ](/api_docs/python/tf/keras/metrics/LogCoshError), [ `tf.compat.v2.metrics.LogCoshError` ](/api_docs/python/tf/keras/metrics/LogCoshError), [ `tf.metrics.LogCoshError` ](/api_docs/python/tf/keras/metrics/LogCoshError)
