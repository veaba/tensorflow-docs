...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/BinaryAccuracy) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L630-L671)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.metrics.BinaryAccuracy`](/api_docs/python/tf/keras/metrics/BinaryAccuracy)
  * Class [`tf.compat.v2.keras.metrics.BinaryAccuracy`](/api_docs/python/tf/keras/metrics/BinaryAccuracy)
  * Class [`tf.compat.v2.metrics.BinaryAccuracy`](/api_docs/python/tf/keras/metrics/BinaryAccuracy)
  * Class [`tf.metrics.BinaryAccuracy`](/api_docs/python/tf/keras/metrics/BinaryAccuracy)
...
then the binary accuracy is 3/4 or .75. If the weights were specified as [1,
0, 0, 1] then the binary accuracy would be 1/2 or .5.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L661-L671)
