...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/Precision) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L1104-L1227)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.metrics.Precision`](/api_docs/python/tf/keras/metrics/Precision)
  * Class [`tf.compat.v2.keras.metrics.Precision`](/api_docs/python/tf/keras/metrics/Precision)
  * Class [`tf.compat.v2.metrics.Precision`](/api_docs/python/tf/keras/metrics/Precision)
  * Class [`tf.metrics.Precision`](/api_docs/python/tf/keras/metrics/Precision)

### Used in the tutorials:

  * [Classification on imbalanced data](https://tensorflow.google.cn/tutorials/structured_data/imbalanced_data)

For example, if `y_true` is [0, 1, 1, 1] and `y_pred` is [1, 0, 1, 1] then the
precision value is 2/(2+1) ie. 0.66. If the weights were specified as [0, 0,
1, 0] then the precision value would be 1.

The metric creates two local variables, `true_positives` and `false_positives`
that are used to compute the precision. This value is ultimately returned as
`precision`, an idempotent operation that simply divides `true_positives` by
the sum of `true_positives` and `false_positives`.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L1144-L1182)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L1215-L1218)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L1210-L1213)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L1184-L1208)
