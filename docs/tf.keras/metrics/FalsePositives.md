...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/FalsePositives) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L904-L950)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.metrics.FalsePositives`](/api_docs/python/tf/keras/metrics/FalsePositives)
  * Class [`tf.compat.v2.keras.metrics.FalsePositives`](/api_docs/python/tf/keras/metrics/FalsePositives)
  * Class [`tf.compat.v2.metrics.FalsePositives`](/api_docs/python/tf/keras/metrics/FalsePositives)
  * Class [`tf.metrics.FalsePositives`](/api_docs/python/tf/keras/metrics/FalsePositives)

### Used in the tutorials:

  * [Classification on imbalanced data](https://tensorflow.google.cn/tutorials/structured_data/imbalanced_data)

For example, if `y_true` is [0, 1, 0, 0] and `y_pred` is [0, 0, 1, 1] then the
false positives value is 2. If the weights were specified as [0, 0, 1, 0] then
the false positives value would be 1.

If `sample_weight` is given, calculates the sum of the weights of false
positives. This metric creates one local variable, `accumulator` that is used
to keep track of the number of false positives.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L934-L950)
