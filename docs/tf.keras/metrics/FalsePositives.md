...
**Aliases** : [ `tf.compat.v1.keras.metrics.FalsePositives` ](/api_docs/python/tf/keras/metrics/FalsePositives), [ `tf.compat.v2.keras.metrics.FalsePositives` ](/api_docs/python/tf/keras/metrics/FalsePositives), [ `tf.compat.v2.metrics.FalsePositives` ](/api_docs/python/tf/keras/metrics/FalsePositives), [ `tf.metrics.FalsePositives` ](/api_docs/python/tf/keras/metrics/FalsePositives)
