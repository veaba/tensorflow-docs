...
version](/versions/r1.15/api_docs/python/tf/keras/metrics/BinaryCrossentropy)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L2493-L2552)  
...
This is the crossentropy metric class to be used when there are only two label
classes (0 and 1).
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/metrics.py#L2529-L2552)
