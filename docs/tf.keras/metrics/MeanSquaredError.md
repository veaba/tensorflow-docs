...
**Aliases** : [ `tf.compat.v1.keras.metrics.MeanSquaredError` ](/api_docs/python/tf/keras/metrics/MeanSquaredError), [ `tf.compat.v2.keras.metrics.MeanSquaredError` ](/api_docs/python/tf/keras/metrics/MeanSquaredError), [ `tf.compat.v2.metrics.MeanSquaredError` ](/api_docs/python/tf/keras/metrics/MeanSquaredError), [ `tf.metrics.MeanSquaredError` ](/api_docs/python/tf/keras/metrics/MeanSquaredError)
