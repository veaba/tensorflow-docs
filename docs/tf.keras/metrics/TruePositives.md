...
**Aliases** : [ `tf.compat.v1.keras.metrics.TruePositives` ](/api_docs/python/tf/keras/metrics/TruePositives), [ `tf.compat.v2.keras.metrics.TruePositives` ](/api_docs/python/tf/keras/metrics/TruePositives), [ `tf.compat.v2.metrics.TruePositives` ](/api_docs/python/tf/keras/metrics/TruePositives), [ `tf.metrics.TruePositives` ](/api_docs/python/tf/keras/metrics/TruePositives)
