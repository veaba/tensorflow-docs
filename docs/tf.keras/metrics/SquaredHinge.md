...
**Aliases** : [ `tf.compat.v1.keras.metrics.SquaredHinge` ](/api_docs/python/tf/keras/metrics/SquaredHinge), [ `tf.compat.v2.keras.metrics.SquaredHinge` ](/api_docs/python/tf/keras/metrics/SquaredHinge), [ `tf.compat.v2.metrics.SquaredHinge` ](/api_docs/python/tf/keras/metrics/SquaredHinge), [ `tf.metrics.SquaredHinge` ](/api_docs/python/tf/keras/metrics/SquaredHinge)
