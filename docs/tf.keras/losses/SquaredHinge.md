...
**别名** : [ `tf.compat.v1.keras.losses.SquaredHinge` ](/api_docs/python/tf/keras/losses/SquaredHinge), [ `tf.compat.v2.keras.losses.SquaredHinge` ](/api_docs/python/tf/keras/losses/SquaredHinge), [ `tf.compat.v2.losses.SquaredHinge` ](/api_docs/python/tf/keras/losses/SquaredHinge), [ `tf.losses.SquaredHinge` ](/api_docs/python/tf/keras/losses/SquaredHinge)
