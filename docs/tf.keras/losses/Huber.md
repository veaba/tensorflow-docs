...
**Aliases** : [ `tf.compat.v1.keras.losses.Huber` ](/api_docs/python/tf/keras/losses/Huber), [ `tf.compat.v2.keras.losses.Huber` ](/api_docs/python/tf/keras/losses/Huber), [ `tf.compat.v2.losses.Huber` ](/api_docs/python/tf/keras/losses/Huber), [ `tf.losses.Huber` ](/api_docs/python/tf/keras/losses/Huber)
