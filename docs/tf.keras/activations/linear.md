...
version](/versions/r1.15/api_docs/python/tf/keras/activations/linear) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/activations.py#L280-L290)  
---|---  
