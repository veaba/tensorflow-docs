...
**Aliases** : [ `tf.compat.v1.keras.activations.tanh` ](/api_docs/python/tf/keras/activations/tanh), [ `tf.compat.v2.keras.activations.tanh` ](/api_docs/python/tf/keras/activations/tanh)
