...
<devsite-code><pre class="prettyprint lang-python" translate="no" dir="ltr" is-upgraded=""><code translate="no" dir="ltr">reduce_lr = ReduceLROnPlateau(monitor='val_loss', factor=0.2,
