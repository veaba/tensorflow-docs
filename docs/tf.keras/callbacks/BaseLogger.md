...
**别名** : [ `tf.compat.v1.keras.callbacks.BaseLogger` ](/api_docs/python/tf/keras/callbacks/BaseLogger), [ `tf.compat.v2.keras.callbacks.BaseLogger` ](/api_docs/python/tf/keras/callbacks/BaseLogger)
