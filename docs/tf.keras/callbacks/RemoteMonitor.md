...
**Aliases** : [ `tf.compat.v1.keras.callbacks.RemoteMonitor` ](/api_docs/python/tf/keras/callbacks/RemoteMonitor), [ `tf.compat.v2.keras.callbacks.RemoteMonitor` ](/api_docs/python/tf/keras/callbacks/RemoteMonitor)
