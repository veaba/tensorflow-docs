...
version](/versions/r1.15/api_docs/python/tf/keras/callbacks/RemoteMonitor) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L1255-L1307)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.callbacks.RemoteMonitor`](/api_docs/python/tf/keras/callbacks/RemoteMonitor)
  * Class [`tf.compat.v2.keras.callbacks.RemoteMonitor`](/api_docs/python/tf/keras/callbacks/RemoteMonitor)

Requires the `requests` library. Events are sent to `root +
'/publish/epoch/end/'` by default. Calls are HTTP POST, with a `data` argument
which is a JSON-encoded dictionary of event data. If send_as_json is set to
True, the content type of the request will be application/json. Otherwise the
serialized JSON will be sent within a form.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L1276-L1288)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L1290-L1307)
