...
**别名** : [ `tf.compat.v1.keras.callbacks.TerminateOnNaN` ](/api_docs/python/tf/keras/callbacks/TerminateOnNaN), [ `tf.compat.v2.keras.callbacks.TerminateOnNaN` ](/api_docs/python/tf/keras/callbacks/TerminateOnNaN)
