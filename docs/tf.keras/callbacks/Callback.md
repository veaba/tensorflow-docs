...
version](/versions/r1.15/api_docs/python/tf/keras/callbacks/Callback) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L422-L626)  
---|---  
...
Currently, the `.fit()` method of the `Model` class will include the following
