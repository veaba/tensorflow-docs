...
version](/versions/r1.15/api_docs/python/tf/keras/callbacks/ProgbarLogger) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L693-L768)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.callbacks.ProgbarLogger`](/api_docs/python/tf/keras/callbacks/ProgbarLogger)
  * Class [`tf.compat.v2.keras.callbacks.ProgbarLogger`](/api_docs/python/tf/keras/callbacks/ProgbarLogger)

#### Arguments:

  * **`count_mode`** : One of "steps" or "samples". Whether the progress bar should count samples seen or steps (batches) seen.
  * **`stateful_metrics`** : Iterable of string names of metrics that should _not_ be averaged over an epoch. Metrics in this list will be logged as-is. All others will be averaged over time (e.g. loss, etc).
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L709-L717)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L739-L740)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L742-L760)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L723-L737)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L762-L768)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/callbacks.py#L719-L721)
