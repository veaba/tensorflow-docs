...
**Aliases** : [ `tf.compat.v1.keras.callbacks.ProgbarLogger` ](/api_docs/python/tf/keras/callbacks/ProgbarLogger), [ `tf.compat.v2.keras.callbacks.ProgbarLogger` ](/api_docs/python/tf/keras/callbacks/ProgbarLogger)
