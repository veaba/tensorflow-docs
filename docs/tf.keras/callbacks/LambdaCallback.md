...
**Aliases** : [ `tf.compat.v1.keras.callbacks.LambdaCallback` ](/api_docs/python/tf/keras/callbacks/LambdaCallback), [ `tf.compat.v2.keras.callbacks.LambdaCallback` ](/api_docs/python/tf/keras/callbacks/LambdaCallback)
