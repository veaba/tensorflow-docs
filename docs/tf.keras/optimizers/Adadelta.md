...
**Aliases** : [ `tf.compat.v1.keras.optimizers.Adadelta` ](/api_docs/python/tf/keras/optimizers/Adadelta), [ `tf.compat.v2.keras.optimizers.Adadelta` ](/api_docs/python/tf/keras/optimizers/Adadelta), [ `tf.compat.v2.optimizers.Adadelta` ](/api_docs/python/tf/keras/optimizers/Adadelta), [ `tf.optimizers.Adadelta` ](/api_docs/python/tf/keras/optimizers/Adadelta)
