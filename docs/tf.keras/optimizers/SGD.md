...
version](/versions/r1.15/api_docs/python/tf/keras/optimizers/SGD) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/optimizer_v2/gradient_descent.py#L29-L164)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.optimizers.SGD`](/api_docs/python/tf/keras/optimizers/SGD)
  * Class [`tf.compat.v2.keras.optimizers.SGD`](/api_docs/python/tf/keras/optimizers/SGD)
  * Class [`tf.compat.v2.optimizers.SGD`](/api_docs/python/tf/keras/optimizers/SGD)
  * Class [`tf.optimizers.SGD`](/api_docs/python/tf/keras/optimizers/SGD)
...
Some of the args below are hyperparameters, where a hyperparameter is defined
as a scalar Tensor, a regular Python value, or a callable (which will be
evaluated when `apply_gradients` is called) returning a scalar Tensor or a
Python value.
...
When eager execution is enabled, learning_rate can be a callable that takes no
arguments and returns the actual value to use. This can be useful for changing
these values across different invocations of optimizer functions.

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/optimizer_v2/gradient_descent.py#L63-L95)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/optimizer_v2/gradient_descent.py#L156-L164)
