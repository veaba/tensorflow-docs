...
**Aliases** : [ `tf.compat.v1.keras.optimizers.SGD` ](/api_docs/python/tf/keras/optimizers/SGD), [ `tf.compat.v2.keras.optimizers.SGD` ](/api_docs/python/tf/keras/optimizers/SGD), [ `tf.compat.v2.optimizers.SGD` ](/api_docs/python/tf/keras/optimizers/SGD), [ `tf.optimizers.SGD` ](/api_docs/python/tf/keras/optimizers/SGD)
