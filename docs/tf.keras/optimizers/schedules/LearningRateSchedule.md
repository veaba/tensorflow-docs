...
[tf.keras.optimizers](https://tensorflow.google.cn/api_docs/python/tf/keras/optimizers)LearningRateSchedules can be passed in as the learning rate of optimizers in . They can be serialized and deserialized using .schedules.serialize and .schedules.deserialize.
