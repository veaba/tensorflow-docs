...
version](/versions/r1.15/api_docs/python/tf/keras/Model) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/engine/training.py#L81-L2880)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.keras.Model`](/api_docs/python/tf/keras/Model)
  * Class [`tf.compat.v1.keras.models.Model`](/api_docs/python/tf/keras/Model)
  * Class [`tf.compat.v2.keras.Model`](/api_docs/python/tf/keras/Model)
  * Class [`tf.compat.v2.keras.models.Model`](/api_docs/python/tf/keras/Model)
  * Class [`tf.keras.models.Model`](/api_docs/python/tf/keras/Model)
...
1 - With the "functional API", where you start from `Input`, you chain layer
calls to specify the model's forward pass, and finally you create your model
...
layers in `__init__` and you should implement the model's forward pass in
`call`.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/engine/training.py#L145-L159)
