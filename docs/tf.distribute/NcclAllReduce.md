...
**别名** : [ `tf.compat.v1.distribute.NcclAllReduce` ](/api_docs/python/tf/distribute/NcclAllReduce), [ `tf.compat.v2.distribute.NcclAllReduce` ](/api_docs/python/tf/distribute/NcclAllReduce)
