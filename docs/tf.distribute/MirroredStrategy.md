...
version](/versions/r1.15/api_docs/python/tf/distribute/MirroredStrategy) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/distribute/mirrored_strategy.py#L339-L357)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v2.distribute.MirroredStrategy`](/api_docs/python/tf/distribute/MirroredStrategy)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/distribute/mirrored_strategy.py#L354-L357)
