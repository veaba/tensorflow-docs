...
>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""> `{'worker': ['job-name=worker-cluster-a', 'job-name=worker-cluster-b'],<br>&nbsp;'ps': ['job-name=ps-1', 'job-name=ps-2']}<br>` </pre></devsite-code>
