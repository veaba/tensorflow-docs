...
version](/versions/r1.15/api_docs/python/tf/debugging/assert_non_positive) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/check_ops.py#L348-L379)  
---|---  
...
### Aliases:
  ...
  * [`tf.compat.v2.debugging.assert_non_positive`](/api_docs/python/tf/debugging/assert_non_positive)
...
Op raising `InvalidArgumentError` unless `x` is all non-positive. This can be
used with
