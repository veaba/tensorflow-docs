...
version](/versions/r1.15/api_docs/python/tf/debugging/assert_negative) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/check_ops.py#L124-L153)  
---|---  
...
### Aliases:
  ...
  * [`tf.compat.v2.debugging.assert_negative`](/api_docs/python/tf/debugging/assert_negative)
...
Op raising `InvalidArgumentError` unless `x` is all negative. This can be used
with
