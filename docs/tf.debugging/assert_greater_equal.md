...
version](/versions/r1.15/api_docs/python/tf/debugging/assert_greater_equal) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/check_ops.py#L1039-L1073)  
...
### Aliases:
  ...
  * [`tf.compat.v2.debugging.assert_greater_equal`](/api_docs/python/tf/debugging/assert_greater_equal)
