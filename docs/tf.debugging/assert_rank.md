...
**Aliases** : [ `tf.assert_rank` ](/api_docs/python/tf/debugging/assert_rank), [ `tf.compat.v2.assert_rank` ](/api_docs/python/tf/debugging/assert_rank), [ `tf.compat.v2.debugging.assert_rank` ](/api_docs/python/tf/debugging/assert_rank)
