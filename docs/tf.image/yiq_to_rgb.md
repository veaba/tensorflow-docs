...
version](/versions/r1.15/api_docs/python/tf/image/yiq_to_rgb) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/image_ops_impl.py#L2883-L2903)  
...
are in [0,1], I value are in [-0.5957,0.5957] and Q value are in
[-0.5226,0.5226].
