...
version](/versions/r1.15/api_docs/python/tf/image/crop_and_resize) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/image_ops_impl.py#L3573-L3633)  
...
or
[`tf.compat.v1.image.resize_nearest_neighbor()`](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/image/resize_nearest_neighbor)(depends
