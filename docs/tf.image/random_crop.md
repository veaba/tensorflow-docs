...
**Aliases** : [ `tf.compat.v1.image.random_crop` ](/api_docs/python/tf/image/random_crop), [ `tf.compat.v1.random_crop` ](/api_docs/python/tf/image/random_crop), [ `tf.compat.v2.image.random_crop` ](/api_docs/python/tf/image/random_crop)
