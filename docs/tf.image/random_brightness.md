...
**Aliases** : [ `tf.compat.v1.image.random_brightness` ](/api_docs/python/tf/image/random_brightness), [ `tf.compat.v2.image.random_brightness` ](/api_docs/python/tf/image/random_brightness)
