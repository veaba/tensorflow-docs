...
>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""> `selected_indices = tf.image.non_max_suppression_overlaps(<br>&nbsp; &nbsp; overlaps, scores, max_output_size, iou_threshold)<br>selected_boxes = tf.gather(boxes, selected_indices)<br>` </pre></devsite-code>
