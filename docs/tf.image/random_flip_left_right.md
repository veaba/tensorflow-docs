...
**Aliases** : [ `tf.compat.v1.image.random_flip_left_right` ](/api_docs/python/tf/image/random_flip_left_right), [ `tf.compat.v2.image.random_flip_left_right` ](/api_docs/python/tf/image/random_flip_left_right)
