...
**Aliases** : [ `tf.compat.v1.image.transpose` ](/api_docs/python/tf/image/transpose), [ `tf.compat.v1.image.transpose_image` ](/api_docs/python/tf/image/transpose), [ `tf.compat.v2.image.transpose` ](/api_docs/python/tf/image/transpose)
