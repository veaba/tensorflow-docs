...
>
<devsite-code><pre class="" translate="no" dir="ltr" is-upgraded=""> `selected_indices_padded, num_valid = tf.image.non_max_suppression_padded(<br>&nbsp; &nbsp; boxes, scores, max_output_size, iou_threshold,<br>&nbsp; &nbsp; score_threshold, pad_to_max_output_size=True)<br>selected_indices = tf.slice(<br>&nbsp; &nbsp; selected_indices_padded, tf.constant([0]), num_valid)<br>selected_boxes = tf.gather(boxes, selected_indices)<br>` </pre></devsite-code>
