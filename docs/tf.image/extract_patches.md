...
- `strides`:` `A` ``1`-D` `T`e`n`s``o``r`` ``o`f` ``l``e`ng`t`h` `4.` `H`o``w`` `fa`r`` ``t`h`e`` ``c``e`n`t``e``r``s`` ``o`f` ``t``w``o`` ``c``o`n`s``e``c`u`t``i`v`e`` `pa`t``c`h`e``s`` `a`r``e`` ``i`n` ``t`h`e`` ``images`.` `Mu`s``t`` `b`e`:` `[`1``,`` ``s``t``r``i``d``e``_``r``o``w``s``,`` ``s``t``r``i``d``e``_``c``o``l``s``,`` ``1`].
- `r``a``t``e``s`:` `A` ``1`-D` `T`e`n`s``o``r`` ``o`f` ``l``e`ng`t`h` `4.` `Mu`s``t`` `b`e`:` `[`1``,`` ``r``a``t``e``_``r``o``w``s``,`` ``r``a``t``e``_``c``o``l``s``,`` ``1`].` `Th`i``s`` ``i``s`` ``t`h`e`` ``i`npu`t`` ``s``t``r``i``d``e``,`` ``s`p`e``c``i`fy`i`ng` `h`o``w`` `f`a``r`` ``t``w``o`` ``c``o`n`s``e``c`u`t``i`v`e`` `p`a``t``c`h` ``s``a`mp`l``e``s`` ``a``r``e`` ``i`n` ``t`h`e`` ``i`npu`t`.` `Equ`i`v`a``l``e`n`t`` ``t``o`` ``e`x`t``r``a``c``t``i`ng` `p`a``t``c`h`e``s`` ``w``i``t`h` `p`a``t``c`h`_``sizes``_``e`ff` `=` `p`a``t``c`h`_``sizes`` `+` `(p`a``t``c`h`_``sizes`` `-` ``1`)` `*` `(`r``a``t``e``s`` `-` ``1`)`,`` `f`o``l``l``o``w``e``d`` `by` ``s`ub`s``a`mp`l``i`ng` ``t`h`e`m` ``s`p`a``t``i``a``l``l`y` `by` ``a`` `f`a``c``t``o``r`` ``o`f` ``r``a``t``e``s`.` `Th`i``s`` ``i``s`` ``e`qu`i`v`a``l``e`n`t`` ``t``o`` ``r``a``t``e`` ``i`n` ``d``i``l``a``t``e``d`` `(`a`.k.`a`.` `A`t``r``o`u`s`)` ``c``o`nv`o``l`u`t``i``o`n`s`.
- `padding`:` `Th`e`` ``t`yp`e`` ``o`f` ``padding`` ``a``l`g`o``r``i``t`hm` ``t``o`` `u`s``e`.
