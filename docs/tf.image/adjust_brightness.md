...
version](/versions/r1.15/api_docs/python/tf/image/adjust_brightness) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/image_ops_impl.py#L1579-L1621)  
---|---  
...
### Aliases:
  ...
  * [`tf.compat.v1.image.adjust_brightness`](/api_docs/python/tf/image/adjust_brightness)
  * [`tf.compat.v2.image.adjust_brightness`](/api_docs/python/tf/image/adjust_brightness)
