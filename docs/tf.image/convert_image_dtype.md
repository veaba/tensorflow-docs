...
**别名** : [ `tf.compat.v1.image.convert_image_dtype` ](/api_docs/python/tf/image/convert_image_dtype), [ `tf.compat.v2.image.convert_image_dtype` ](/api_docs/python/tf/image/convert_image_dtype)
