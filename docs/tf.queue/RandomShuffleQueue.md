...
**Aliases** : [ `tf.compat.v1.RandomShuffleQueue` ](/api_docs/python/tf/queue/RandomShuffleQueue), [ `tf.compat.v1.io.RandomShuffleQueue` ](/api_docs/python/tf/queue/RandomShuffleQueue), [ `tf.compat.v1.queue.RandomShuffleQueue` ](/api_docs/python/tf/queue/RandomShuffleQueue), [ `tf.compat.v2.queue.RandomShuffleQueue` ](/api_docs/python/tf/queue/RandomShuffleQueue)
