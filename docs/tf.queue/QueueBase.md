...
[tf.queue.FIFOQueue](https://tensorflow.google.cn/api_docs/python/tf/queue/FIFOQueue)See  and tf.queue.RandomShuffleQueue for concrete implementations of this class, and instructions on how to create them.
