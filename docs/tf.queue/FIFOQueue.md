...
**别名** : [ `tf.compat.v1.FIFOQueue` ](/api_docs/python/tf/queue/FIFOQueue), [ `tf.compat.v1.queue.FIFOQueue` ](/api_docs/python/tf/queue/FIFOQueue), [ `tf.compat.v2.queue.FIFOQueue` ](/api_docs/python/tf/queue/FIFOQueue)
