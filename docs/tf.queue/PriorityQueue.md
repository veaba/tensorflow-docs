...
**别名** : [ `tf.compat.v1.PriorityQueue` ](/api_docs/python/tf/queue/PriorityQueue), [ `tf.compat.v1.io.PriorityQueue` ](/api_docs/python/tf/queue/PriorityQueue), [ `tf.compat.v1.queue.PriorityQueue` ](/api_docs/python/tf/queue/PriorityQueue), [ `tf.compat.v2.queue.PriorityQueue` ](/api_docs/python/tf/queue/PriorityQueue)
