...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorFullMatrix` ](/api_docs/python/tf/linalg/LinearOperatorFullMatrix), [ `tf.compat.v2.linalg.LinearOperatorFullMatrix` ](/api_docs/python/tf/linalg/LinearOperatorFullMatrix)
