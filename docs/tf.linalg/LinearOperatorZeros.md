...
[LinearOperator](https://tensorflow.google.cn/api_docs/python/tf/linalg/LinearOperator)Inherits From: 
...
[tf.shape(A)](https://tensorflow.google.cn/api_docs/python/tf/shape)If this operator acts like the batch matrix A with A.shape = [B1,...,Bb, M, N], then this returns a Tensor holding [B1,...,Bb, M, N], equivalent to .
