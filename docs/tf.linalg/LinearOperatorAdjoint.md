...
**Aliases** : [ `tf.compat.v1.linalg.LinearOperatorAdjoint` ](/api_docs/python/tf/linalg/LinearOperatorAdjoint), [ `tf.compat.v2.linalg.LinearOperatorAdjoint` ](/api_docs/python/tf/linalg/LinearOperatorAdjoint)
...
#### Performance
The performance of  `LinearOperatorAdjoint`  depends on the underlyingoperators performance.
