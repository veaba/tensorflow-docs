...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorAdjoint) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_adjoint.py#L33-L213)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperatorAdjoint`](/api_docs/python/tf/linalg/LinearOperatorAdjoint)
  * Class [`tf.compat.v2.linalg.LinearOperatorAdjoint`](/api_docs/python/tf/linalg/LinearOperatorAdjoint)
...
The performance of `LinearOperatorAdjoint` depends on the underlying operators
performance.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_adjoint.py#L78-L153)
...
`LinearOperatorAdjoint` is initialized with an operator `A`. The `solve` and
`matmul` methods effectively flip the `adjoint` argument. E.g.
