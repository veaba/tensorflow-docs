...
**别名** : [ `tf.compat.v1.linalg.LinearOperator` ](/api_docs/python/tf/linalg/LinearOperator), [ `tf.compat.v2.linalg.LinearOperator` ](/api_docs/python/tf/linalg/LinearOperator)
