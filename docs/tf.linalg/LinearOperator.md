...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperator) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator.py#L49-L1030)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperator`](/api_docs/python/tf/linalg/LinearOperator)
  * Class [`tf.compat.v2.linalg.LinearOperator`](/api_docs/python/tf/linalg/LinearOperator)
...
`assert_non_singular`) if they can be done in less than `O(N^3)` time.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator.py#L150-L210)
...
**This is a private method for subclass use.** **Subclasses should copy-paste
this`__init__` documentation.**
