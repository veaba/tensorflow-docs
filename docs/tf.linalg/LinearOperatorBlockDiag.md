...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorBlockDiag` ](/api_docs/python/tf/linalg/LinearOperatorBlockDiag), [ `tf.compat.v2.linalg.LinearOperatorBlockDiag` ](/api_docs/python/tf/linalg/LinearOperatorBlockDiag)
