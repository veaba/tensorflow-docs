...
version](/versions/r1.15/api_docs/python/tf/linalg/tridiagonal_matmul) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linalg_impl.py#L549-L636)  
...
### Aliases:
  ...
  * [`tf.compat.v2.linalg.tridiagonal_matmul`](/api_docs/python/tf/linalg/tridiagonal_matmul)
...
`superdiag` first element of `subdiag` are ignored.
