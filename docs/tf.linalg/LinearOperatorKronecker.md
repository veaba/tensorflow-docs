...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorKronecker) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_kronecker.py#L66-L560)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperatorKronecker`](/api_docs/python/tf/linalg/LinearOperatorKronecker)
  * Class [`tf.compat.v2.linalg.LinearOperatorKronecker`](/api_docs/python/tf/linalg/LinearOperatorKronecker)

This operator composes one or more linear operators `[op1,...,opJ]`, building
a new `LinearOperator` representing the Kronecker product: `op1 x op2 x ..
opJ` (we omit parentheses as the Kronecker product is associative).

If `opj` has shape `batch_shape_j + [M_j, N_j]`, then the composed operator
will have shape equal to `broadcast_batch_shape + [prod M_j, prod N_j]`, where
the product is over all operators.
...
The performance of `LinearOperatorKronecker` on any operation is equal to the
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_kronecker.py#L137-L229)
