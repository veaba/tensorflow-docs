...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorDiag) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_diag.py#L34-L249)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperatorDiag`](/api_docs/python/tf/linalg/LinearOperatorDiag)
  * Class [`tf.compat.v2.linalg.LinearOperatorDiag`](/api_docs/python/tf/linalg/LinearOperatorDiag)

This operator acts like a [batch] diagonal matrix `A` with shape `[B1,...,Bb,
...
Suppose `operator` is a `LinearOperatorDiag` of shape `[N, N]`, and `x.shape =
[N, R]`. Then
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_diag.py#L114-L166)
