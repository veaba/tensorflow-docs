...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorDiag` ](/api_docs/python/tf/linalg/LinearOperatorDiag), [ `tf.compat.v2.linalg.LinearOperatorDiag` ](/api_docs/python/tf/linalg/LinearOperatorDiag)
