...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorToeplitz` ](/api_docs/python/tf/linalg/LinearOperatorToeplitz), [ `tf.compat.v2.linalg.LinearOperatorToeplitz` ](/api_docs/python/tf/linalg/LinearOperatorToeplitz)
