...
**Aliases** : [ `tf.compat.v1.linalg.LinearOperatorIdentity` ](/api_docs/python/tf/linalg/LinearOperatorIdentity), [ `tf.compat.v2.linalg.LinearOperatorIdentity` ](/api_docs/python/tf/linalg/LinearOperatorIdentity)
