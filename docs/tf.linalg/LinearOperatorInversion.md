...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorInversion) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_inversion.py#L30-L198)  
---|---  
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_inversion.py#L76-L166)
...
`LinearOperatorInversion` is initialized with an operator `A`. The `solve` and
`matmul` methods are effectively swapped. E.g.
