...
**Aliases** : [ `tf.compat.v1.linalg.LinearOperatorInversion` ](/api_docs/python/tf/linalg/LinearOperatorInversion), [ `tf.compat.v2.linalg.LinearOperatorInversion` ](/api_docs/python/tf/linalg/LinearOperatorInversion)
...
#### Performance
The performance of  `LinearOperatorInversion`  depends on the underlyingoperators performance:   `solve`  and  `matmul`  are swapped, and determinant isinverted.
