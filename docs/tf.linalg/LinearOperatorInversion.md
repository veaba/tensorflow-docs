...
- Class [ `tf.compat.v1.linalg.LinearOperatorInversion` ](/api_docs/python/tf/linalg/LinearOperatorInversion)

- Class [ `tf.compat.v2.linalg.LinearOperatorInversion` ](/api_docs/python/tf/linalg/LinearOperatorInversion)
...
##  `__init__` 
[View source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_inversion.py#L76-L166)
...
- **`name`** : A name for this  `LinearOperator` . Default is <code translate="no" dir="ltr">operator.name +
"_inv"</code>.
