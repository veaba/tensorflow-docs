...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorInversion` ](/api_docs/python/tf/linalg/LinearOperatorInversion), [ `tf.compat.v2.linalg.LinearOperatorInversion` ](/api_docs/python/tf/linalg/LinearOperatorInversion)
