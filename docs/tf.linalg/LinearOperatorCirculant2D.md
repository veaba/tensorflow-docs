...
**Aliases** : [ `tf.compat.v1.linalg.LinearOperatorCirculant2D` ](/api_docs/python/tf/linalg/LinearOperatorCirculant2D), [ `tf.compat.v2.linalg.LinearOperatorCirculant2D` ](/api_docs/python/tf/linalg/LinearOperatorCirculant2D)
