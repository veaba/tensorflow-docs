...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorCirculant3D` ](/api_docs/python/tf/linalg/LinearOperatorCirculant3D), [ `tf.compat.v2.linalg.LinearOperatorCirculant3D` ](/api_docs/python/tf/linalg/LinearOperatorCirculant3D)
