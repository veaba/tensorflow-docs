...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorHouseholder)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_householder.py#L35-L241)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperatorHouseholder`](/api_docs/python/tf/linalg/LinearOperatorHouseholder)
  * Class [`tf.compat.v2.linalg.LinearOperatorHouseholder`](/api_docs/python/tf/linalg/LinearOperatorHouseholder)
...
this shape will be relevant.

`LinearOperatorHouseholder` is initialized with a (batch) vector.

A Householder reflection, defined via a vector `v`, which reflects points in
`R^n` about the hyperplane orthogonal to `v` and through the origin.
