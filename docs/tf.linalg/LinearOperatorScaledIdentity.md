...
**别名** : [ `tf.compat.v1.linalg.LinearOperatorScaledIdentity` ](/api_docs/python/tf/linalg/LinearOperatorScaledIdentity), [ `tf.compat.v2.linalg.LinearOperatorScaledIdentity` ](/api_docs/python/tf/linalg/LinearOperatorScaledIdentity)
