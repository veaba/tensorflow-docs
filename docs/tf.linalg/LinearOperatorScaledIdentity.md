...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorScaledIdentity)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_identity.py#L469-L730)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperatorScaledIdentity`](/api_docs/python/tf/linalg/LinearOperatorScaledIdentity)
  * Class [`tf.compat.v2.linalg.LinearOperatorScaledIdentity`](/api_docs/python/tf/linalg/LinearOperatorScaledIdentity)
...
member. For every batch index `(i1,...,ib)`, `A[i1,...,ib, : :]` is a scaled
version of the `N x N` identity matrix.

`LinearOperatorIdentity` is initialized with `num_rows`, and a `multiplier` (a
`Tensor`) of shape `[B1,...,Bb]`. `N` is set to `num_rows`, and the
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_identity.py#L554-L625)
...
determines the size of each identity matrix, and a `multiplier`, which defines
`dtype`, batch shape, and scale of each matrix.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_identity.py#L702-L725)
