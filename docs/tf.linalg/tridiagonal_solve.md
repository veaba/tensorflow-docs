...
you need to cast a tensor into a compact format manually, use [ `tf.gather_nd` ](https://tensorflow.google.cn/api_docs/python/tf/gather_nd).
...
invertible. [ `tf.debugging.check_numerics` ](https://tensorflow.google.cn/api_docs/python/tf/debugging/check_numerics) can be applied to the output to
