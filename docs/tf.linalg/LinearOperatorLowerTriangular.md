...
version](/versions/r1.15/api_docs/python/tf/linalg/LinearOperatorLowerTriangular)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_lower_triangular.py#L35-L204)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.linalg.LinearOperatorLowerTriangular`](/api_docs/python/tf/linalg/LinearOperatorLowerTriangular)
  * Class [`tf.compat.v2.linalg.LinearOperatorLowerTriangular`](/api_docs/python/tf/linalg/LinearOperatorLowerTriangular)
...
dimensions `[B1,...,Bb, N, N]`. The upper triangle of the last two dimensions
is ignored.
...
Suppose `operator` is a `LinearOperatorLowerTriangular` of shape `[N, N]`, and
`x.shape = [N, R]`. Then
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/linalg/linear_operator_lower_triangular.py#L109-L158)
