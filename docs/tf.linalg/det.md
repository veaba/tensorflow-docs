...
**Aliases** : [ `tf.compat.v1.linalg.det` ](/api_docs/python/tf/linalg/det), [ `tf.compat.v1.matrix_determinant` ](/api_docs/python/tf/linalg/det), [ `tf.compat.v2.linalg.det` ](/api_docs/python/tf/linalg/det)
