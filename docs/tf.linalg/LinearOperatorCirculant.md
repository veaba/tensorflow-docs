...
**Aliases** : [ `tf.compat.v1.linalg.LinearOperatorCirculant` ](/api_docs/python/tf/linalg/LinearOperatorCirculant), [ `tf.compat.v2.linalg.LinearOperatorCirculant` ](/api_docs/python/tf/linalg/LinearOperatorCirculant)
