...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/feature_column/feature_column_v2.py#L1097-L1260)  
---  
...
### Aliases:
  ...
  * [`tf.compat.v2.feature_column.shared_embeddings`](/api_docs/python/tf/feature_column/shared_embeddings)
