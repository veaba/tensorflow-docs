...
**Aliases** : [ `tf.compat.v1.feature_column.categorical_column_with_identity` ](/api_docs/python/tf/feature_column/categorical_column_with_identity), [ `tf.compat.v2.feature_column.categorical_column_with_identity` ](/api_docs/python/tf/feature_column/categorical_column_with_identity)
