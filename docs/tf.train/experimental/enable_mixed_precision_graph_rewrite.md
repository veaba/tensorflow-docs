...
precision to speed up the execution time of [ `tf.function` ](https://tensorflow.google.cn/api_docs/python/tf/function)s when run on a GPU.
...
[ `tf.GradientTape` ](https://tensorflow.google.cn/api_docs/python/tf/GradientTape). This is because the returned optimizer will apply loss
scaling, and [ `tf.GradientTape` ](https://tensorflow.google.cn/api_docs/python/tf/GradientTape) will not. If you do use a [ `tf.GradientTape` ](https://tensorflow.google.cn/api_docs/python/tf/GradientTape),
