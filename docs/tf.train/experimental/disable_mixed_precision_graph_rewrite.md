...
version](/versions/r1.15/api_docs/python/tf/train/experimental/disable_mixed_precision_graph_rewrite)
...
### Aliases:
  ...
  * [`tf.compat.v2.train.experimental.disable_mixed_precision_graph_rewrite`](/api_docs/python/tf/train/experimental/disable_mixed_precision_graph_rewrite)
