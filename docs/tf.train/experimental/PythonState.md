...
[tf.train.Checkpoint](https://tensorflow.google.cn/api_docs/python/tf/train/Checkpoint)This is an abstract class which allows extensions to TensorFlow's object-based checkpointing (see ). For example a wrapper for NumPy arrays:
