...
[tf.compat.v1.global_variables()](https://tensorflow.google.cn/api_docs/python/tf/compat/v1/global_variables)shadow variables are created with trainable=False and added to the GraphKeys.ALL_VARIABLES collection. They will be returned by calls to .
