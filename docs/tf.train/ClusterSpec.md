...
A [ `tf.train.ClusterSpec` ](https://tensorflow.google.cn/api_docs/python/tf/train/ClusterSpec) represents the set of processes that
participate in a distributed TensorFlow computation. Every
[ `tf.distribute.Server` ](https://tensorflow.google.cn/api_docs/python/tf/distribute/Server) is constructed in a particular cluster.
...
network addresses; or a [ `tf.train.ClusterDef` ](https://tensorflow.google.cn/api_docs/python/tf/train/ClusterDef) protocol buffer.
...
of strings, and not a [ `tf.train.ClusterDef` ](https://tensorflow.google.cn/api_docs/python/tf/train/ClusterDef) protobuf.
...
this job. Use the [ `tf.train.ClusterSpec.num_tasks` ](https://tensorflow.google.cn/api_docs/python/tf/train/ClusterSpec#num_tasks) method
