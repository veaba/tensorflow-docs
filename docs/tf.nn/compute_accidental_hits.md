...
**Aliases** : [ `tf.compat.v1.nn.compute_accidental_hits` ](/api_docs/python/tf/nn/compute_accidental_hits), [ `tf.compat.v2.nn.compute_accidental_hits` ](/api_docs/python/tf/nn/compute_accidental_hits)
