...
```
[tf.nn.convolution](https://tensorflow.google.cn/api_docs/python/tf/nn/convolution)This function is a simpler wrapper around the more general , and exists only for backwards compatibility. You can use  to perform 1-D, 2-D, or 3-D atrous convolution.
