...
version](/versions/r1.15/api_docs/python/tf/nn/depthwise_conv2d) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/nn_impl.py#L830-L885)  
...
### Aliases:
  ...
  * [`tf.compat.v2.nn.depthwise_conv2d`](/api_docs/python/tf/nn/depthwise_conv2d)
