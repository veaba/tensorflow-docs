...
version](/versions/r1.15/api_docs/python/tf/nn/convolution) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/nn_ops.py#L901-L917)  
---|---  
...
### Aliases:
  ...
  * [`tf.compat.v2.nn.convolution`](/api_docs/python/tf/nn/convolution)
...
supported for atrous convolutions.
...
an optional `dilations` tensor of shape
[N](/api_docs/python/tf/nn/defaulting%20to%20%5B1%5D*N) specifying the filter
...
output striding `strides` as described in the [comment
here](https://tensorflow.org/api_guides/python/nn#Convolution).
