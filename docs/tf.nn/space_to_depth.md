...
version](/versions/r1.15/api_docs/python/tf/nn/space_to_depth) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/array_ops.py#L3252-L3254)  
---|---  
...
### Aliases:
  ...
  * [`tf.compat.v2.nn.space_to_depth`](/api_docs/python/tf/nn/space_to_depth)
