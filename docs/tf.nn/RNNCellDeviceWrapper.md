...
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/rnn_cell_wrapper_v2.py#L115-L122)  
---  
...
### Aliases:
  ...
  * Class [`tf.compat.v2.nn.RNNCellDeviceWrapper`](/api_docs/python/tf/nn/RNNCellDeviceWrapper)

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/keras/layers/rnn_cell_wrapper_v2.py#L119-L120)
