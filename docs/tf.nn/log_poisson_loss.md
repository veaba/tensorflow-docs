...
version](/versions/r1.15/api_docs/python/tf/nn/log_poisson_loss) |  [
...
### Aliases:
  ...
  * [`tf.compat.v2.nn.log_poisson_loss`](/api_docs/python/tf/nn/log_poisson_loss)
...
For brevity, let `c = log(x) = log_input`, `z = targets`. The log Poisson loss
is
