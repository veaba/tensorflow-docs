...
version](/versions/r1.15/api_docs/python/tf/nn/embedding_lookup_sparse) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/embedding_ops.py#L541-L618)  
---|---  
...
weight, and combines these embeddings as specified.
