...
version](/versions/r1.15/api_docs/python/tf/lite/Interpreter) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L173-L456)  
---|---  
...
This makes the TensorFlow Lite interpreter accessible in Python. It is
possible to use this interpreter in a multithreaded Python environment, but
you must be sure to call functions of a particular instance from only one
thread at a time. So if you want to have 4 threads running different
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L187-L231)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L242-L244)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L322-L330)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L365-L373)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L375-L388)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L305-L320)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L440-L453)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L455-L456)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L348-L363)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L332-L346)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/lite/python/interpreter.py#L390-L438)
