...
**别名** : [ `tf.compat.v1.errors.UnauthenticatedError` ](/api_docs/python/tf/errors/UnauthenticatedError), [ `tf.compat.v2.errors.UnauthenticatedError` ](/api_docs/python/tf/errors/UnauthenticatedError)
