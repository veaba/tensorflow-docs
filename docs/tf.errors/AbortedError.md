...
**Aliases** : [ `tf.compat.v1.errors.AbortedError` ](/api_docs/python/tf/errors/AbortedError), [ `tf.compat.v2.errors.AbortedError` ](/api_docs/python/tf/errors/AbortedError)
