...
[ `tf.matmul` ](https://tensorflow.google.cn/api_docs/python/tf/linalg/matmul) op will raise this
error if it receives an input that is not a matrix, and the
[ `tf.reshape` ](https://tensorflow.google.cn/api_docs/python/tf/reshape) op will raise
