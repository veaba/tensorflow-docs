...
version](/versions/r1.15/api_docs/python/tf/errors/OpError) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/errors_impl.py#L59-L167)  
...
### Aliases:
  ...
  * Class [`tf.compat.v1.OpError`](/api_docs/python/tf/errors/OpError)
  * Class [`tf.compat.v1.errors.OpError`](/api_docs/python/tf/errors/OpError)
  * Class [`tf.compat.v2.errors.OpError`](/api_docs/python/tf/errors/OpError)

Whenever possible, the session will raise a more specific subclass of
`OpError` from the
[`tf.errors`](https://tensorflow.google.cn/api_docs/python/tf/errors) module.

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/errors_impl.py#L66-L80)
