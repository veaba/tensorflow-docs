...
[tf.errors](https://tensorflow.google.cn/api_docs/python/tf/errors)Whenever possible, the session will raise a more specific subclass of OpError from the  module.
