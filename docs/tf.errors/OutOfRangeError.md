...
**Aliases** : [ `tf.compat.v1.errors.OutOfRangeError` ](/api_docs/python/tf/errors/OutOfRangeError), [ `tf.compat.v2.errors.OutOfRangeError` ](/api_docs/python/tf/errors/OutOfRangeError)
