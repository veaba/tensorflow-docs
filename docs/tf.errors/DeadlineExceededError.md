...
**别名** : [ `tf.compat.v1.errors.DeadlineExceededError` ](/api_docs/python/tf/errors/DeadlineExceededError), [ `tf.compat.v2.errors.DeadlineExceededError` ](/api_docs/python/tf/errors/DeadlineExceededError)
