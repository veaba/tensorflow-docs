...
version](/versions/r1.15/api_docs/python/tf/errors/NotFoundError) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/errors_impl.py#L288-L301)  
---|---  
...
`NotFoundError` if it receives the name of a file that does not exist.

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/errors_impl.py#L299-L301)
