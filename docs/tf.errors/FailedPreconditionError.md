...
[tf.Variable](https://tensorflow.google.cn/api_docs/python/tf/Variable)This exception is most commonly raised when running an operation that reads a  before it has been initialized.
