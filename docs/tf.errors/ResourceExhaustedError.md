...
version](/versions/r1.15/api_docs/python/tf/errors/ResourceExhaustedError) |
...
### Aliases:
  ...
  * Class [`tf.compat.v1.errors.ResourceExhaustedError`](/api_docs/python/tf/errors/ResourceExhaustedError)
  * Class [`tf.compat.v2.errors.ResourceExhaustedError`](/api_docs/python/tf/errors/ResourceExhaustedError)

For example, this error might be raised if a per-user quota is exhausted, or
perhaps the entire file system is out of space.

## `__init__`

[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/errors_impl.py#L365-L368)
