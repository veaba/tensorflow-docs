...
**别名** : [ `tf.compat.v1.errors.ResourceExhaustedError` ](/api_docs/python/tf/errors/ResourceExhaustedError), [ `tf.compat.v2.errors.ResourceExhaustedError` ](/api_docs/python/tf/errors/ResourceExhaustedError)
