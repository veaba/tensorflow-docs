...
[ `tf.TypeSpec` ](https://tensorflow.google.cn/api_docs/python/tf/TypeSpec), including [ `tf.Tensor` ](https://tensorflow.google.cn/api_docs/python/tf/Tensor), [ `tf.data.Dataset` ](https://tensorflow.google.cn/api_docs/python/tf/data/Dataset), [ `tf.SparseTensor` ](https://tensorflow.google.cn/api_docs/python/tf/sparse/SparseTensor),
[ `tf.RaggedTensor` ](https://tensorflow.google.cn/api_docs/python/tf/RaggedTensor), or [ `tf.TensorArray` ](https://tensorflow.google.cn/api_docs/python/tf/TensorArray).
