...
version](/versions/r1.15/api_docs/python/tf/data/Dataset) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/ops/dataset_ops.py#L105-L1599)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v2.data.Dataset`](/api_docs/python/tf/data/Dataset)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/ops/dataset_ops.py#L132-L153)
