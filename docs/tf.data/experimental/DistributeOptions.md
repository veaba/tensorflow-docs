...
[tf.data.Options](https://www.tensorflow.org/api_docs/python/tf/data/Options)You can set the distribution options of a dataset through the experimental_distribute property of ; the property is an instance of tf.data.experimental.DistributeOptions.
