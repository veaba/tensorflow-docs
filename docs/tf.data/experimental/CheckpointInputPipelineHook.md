...
[ `tf.data.experimental.make_saveable_from_iterator` ](https://tensorflow.google.cn/api_docs/python/tf/data/experimental/make_saveable_from_iterator) directly to create a
