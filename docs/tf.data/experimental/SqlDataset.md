...
version](/versions/r1.15/api_docs/python/tf/data/experimental/SqlDataset) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/experimental/ops/readers.py#L947-L991)  
...
### Aliases:
  ...
  * Class [`tf.compat.v2.data.experimental.SqlDataset`](/api_docs/python/tf/data/experimental/SqlDataset)
