...
[tf.data.Options](https://tensorflow.google.cn/api_docs/python/tf/data/Options)You can set the threading options of a dataset through the experimental_threading property of ; the property is an instance of tf.data.experimental.ThreadingOptions.
