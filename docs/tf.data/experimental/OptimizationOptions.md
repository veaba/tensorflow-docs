...
[tf.data.Options](https://www.tensorflow.org/api_docs/python/tf/data/Options)You can set the optimization options of a dataset through the experimental_optimization property of ; the property is an instance of tf.data.experimental.OptimizationOptions.
...
### map_vectorization
[tf.data.experimental.MapVectorizationOptions](https://www.tensorflow.org/api_docs/python/tf/data/experimental/MapVectorizationOptions)The map vectorization options associated with the dataset. See  for more details.
