...
**Aliases** : [ `tf.compat.v1.data.experimental.get_structure` ](/api_docs/python/tf/data/experimental/get_structure), [ `tf.compat.v2.data.experimental.get_structure` ](/api_docs/python/tf/data/experimental/get_structure)
