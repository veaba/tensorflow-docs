...
**Aliases** : [ `tf.compat.v1.data.experimental.ignore_errors` ](/api_docs/python/tf/data/experimental/ignore_errors), [ `tf.compat.v2.data.experimental.ignore_errors` ](/api_docs/python/tf/data/experimental/ignore_errors)
