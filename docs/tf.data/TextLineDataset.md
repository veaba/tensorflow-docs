...
version](/versions/r1.15/api_docs/python/tf/data/TextLineDataset) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/ops/readers.py#L122-L160)  
---|---  
...
### Aliases:
  ...
  * Class [`tf.compat.v2.data.TextLineDataset`](/api_docs/python/tf/data/TextLineDataset)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/data/ops/readers.py#L125-L156)
