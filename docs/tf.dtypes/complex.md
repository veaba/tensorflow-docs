...
```
Given a tensor `real` representing the `real` part of a complex number, and a tensor `imag` representing the `imag`inary part of a complex number, this operation returns complex numbers elementwise of the form
