...
**Aliases** : [ `tf.compat.v1.nn.learned_unigram_candidate_sampler` ](/api_docs/python/tf/random/learned_unigram_candidate_sampler), [ `tf.compat.v1.random.learned_unigram_candidate_sampler` ](/api_docs/python/tf/random/learned_unigram_candidate_sampler), [ `tf.compat.v2.nn.learned_unigram_candidate_sampler` ](/api_docs/python/tf/random/learned_unigram_candidate_sampler), [ `tf.compat.v2.random.learned_unigram_candidate_sampler` ](/api_docs/python/tf/random/learned_unigram_candidate_sampler), [ `tf.nn.learned_unigram_candidate_sampler` ](/api_docs/python/tf/random/learned_unigram_candidate_sampler)
