...
version](/versions/r1.15/api_docs/python/tf/random/experimental/get_global_generator)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/stateful_random_ops.py#L679-L684)  
---|---  
