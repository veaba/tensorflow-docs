...
**Aliases** : [ `tf.compat.v1.strings.unicode_split` ](/api_docs/python/tf/strings/unicode_split), [ `tf.compat.v2.strings.unicode_split` ](/api_docs/python/tf/strings/unicode_split)
