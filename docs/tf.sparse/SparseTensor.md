...
**Aliases** : [ `tf.SparseTensor` ](/api_docs/python/tf/sparse/SparseTensor), [ `tf.compat.v1.SparseTensor` ](/api_docs/python/tf/sparse/SparseTensor), [ `tf.compat.v1.sparse.SparseTensor` ](/api_docs/python/tf/sparse/SparseTensor), [ `tf.compat.v2.SparseTensor` ](/api_docs/python/tf/sparse/SparseTensor), [ `tf.compat.v2.sparse.SparseTensor` ](/api_docs/python/tf/sparse/SparseTensor)
