...
version](/versions/r1.15/api_docs/python/tf/sparse/SparseTensor) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/sparse_tensor.py#L45-L251)  
---|---  
...
comprises the following components, where `N` and `ndims` are the number of
values and number of dimensions in the `SparseTensor`, respectively:
...
obtained by calling
[`tf.sparse.reorder(st)`](https://tensorflow.google.cn/api_docs/python/tf/sparse/reorder).
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/sparse_tensor.py#L115-L143)
...
A 2-D Tensor of int64 with dense_shape `[N, ndims]`, where `N` is the number
of non-zero values in the tensor, and `ndims` is the rank.
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/math_ops.py#L914-L920)
...
_Limitation_ : this Op only broadcasts the dense side to the sparse side, but
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/sparse_tensor.py#L250-L251)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/sparse_tensor.py#L205-L228)
...
[`SparseTensor.eval()`](https://tensorflow.google.cn/api_docs/python/tf/sparse/SparseTensor#eval),
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/sparse_tensor.py#L105-L113)
...
[View
source](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/sparse_tensor.py#L145-L151)
