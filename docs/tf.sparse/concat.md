...
version](/versions/r1.15/api_docs/python/tf/sparse/concat) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/sparse_ops.py#L331-L363)  
...
### Aliases:
  ...
  * [`tf.compat.v2.sparse.concat`](/api_docs/python/tf/sparse/concat)
...
**Warning:** SOME ARGUMENTS ARE DEPRECATED: `(concat_dim)`. They will be
removed in a future version. Instructions for updating: concat_dim is
