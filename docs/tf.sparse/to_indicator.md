...
version](/versions/r1.15/api_docs/python/tf/sparse/to_indicator) |  [
...
Note that repeats are allowed in the input SparseTensor. This op is useful for
converting `SparseTensor`s into dense formats for compatibility with ops that
