...
version](/versions/r1.15/api_docs/python/tf/sparse/reset_shape) |  [
![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/sparse_ops.py#L1751-L1853)  
---|---  
...
zeros if sp_input has no values.
...
Consider a `sp_input` with shape [2, 3, 5]:
  ...
  * On the other hand, setting new_shape as [2, 3, 4] is also an error: The third dimension is smaller than the original shape [2, 3, 5](/api_docs/python/tf/sparse/and%20an%0A%60InvalidArgumentError%60%20will%20be%20raised).
