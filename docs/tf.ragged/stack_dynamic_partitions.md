...
version](/versions/r1.15/api_docs/python/tf/ragged/stack_dynamic_partitions) |
[ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source on
GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/ops/ragged/ragged_array_ops.py#L530-L630)  
---|---  
...
`partitions[j1...jN] = i`. Slices of `data` are stacked in row-major order.
