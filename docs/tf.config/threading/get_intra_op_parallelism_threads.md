...
version](/versions/r1.15/api_docs/python/tf/config/threading/get_intra_op_parallelism_threads)
|  [ ![](https://tensorflow.google.cn/images/GitHub-Mark-32px.png) View source
on GitHub
](https://github.com/tensorflow/tensorflow/blob/r2.0/tensorflow/python/framework/config.py#L25-L36)  
